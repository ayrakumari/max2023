    ...
    <head>
        ...
        <!--begin::Global Theme Styles -->
                    ...
                    <link href="{{ asset('local/public/themes/default/assets/vendors/base/vendors.bundle.css') }}" rel="stylesheet" type="text/css" />
										...
										<link href="{{ asset('local/public/themes/default/assets/sweetalert2.scss') }}" rel="stylesheet" type="text/css" />
...
<div class="m-grid m-grid--hor m-grid--root m-page">
	...
	<div class="m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1	m-login__content m-grid-item--center" style="background:#16426B">
		<div class="m-grid__item">
			<centre>
			<h3 class="m-login__welcome">MAXNOVA </h3>
			</centre>
