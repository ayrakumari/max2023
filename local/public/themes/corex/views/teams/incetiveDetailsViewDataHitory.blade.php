				...
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title">
						<h3 class="m-portlet__head-text">
							INSH.Incentive Details View History:New Sales
						</h3>
					</div>
				</div>
			</div>
										...
										<div class="m-widget28__tab tab-content">
											<div id="menu11" class="m-widget28__tab-container tab-pane active">
												<div class="m-widget28__tab-items">
													...
													<div class="m-widget28__tab-item">
														<span>No.of min Order Value above 75K: <b>{{$cCountDataMinOrder}}</b> <i style="color:{{$stCM}}" class="fa fa-check-square"></i> <a href="{{route('getMonthwiseOrderDetails',[$uid,$In_month,$In_year])}}" title="View Detail" class="btn btn-outline-primary m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air"></a> </span>
														<!-- <span>NA</span> -->
													</div>
													<div class="m-widget28__tab-item">
