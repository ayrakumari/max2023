				...
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title">
						<h3 class="m-portlet__head-text">
							INS:Incentive Details View : <span style="color:#035496">{{AyraHelp::getUser( Request::segment(2))->name}}</span>
						</h3>
					</div>
				</div>
			</div>
											...
											<div class="m-widget28__tab tab-content">
												<div id="menu11" class="m-widget28__tab-container tab-pane active">
													<div class="m-widget28__tab-items">
														...
														<div class="m-widget28__tab-item">
															<?php
															$cCountData = AyraHelp::getNewClient($uid, date('m'), date('Y'));
															$cCountDataMinOrder = AyraHelp::getMinOrderValue($uid, date('m'), date('Y'));
															$cCountDataMinProductAddition = AyraHelp::getMinProductAdditon($uid, date('m'), date('Y'));
															...
															if ($cCountDataMinProductAddition >= 2) {
																$stCMA = "green";
																$ie++;
															} else {
																$stCMA = "red";
															...
															?>
															<span>No .of new client: <b>{{$cCountData}}</b> <i style="color:{{$stC}}" class="fa fa-check-square"></i></span>
															<!-- <span>NA</span> -->
														</div>
														<div class="m-widget28__tab-item">
															<span>No.of min Order Value above 75K: <b>{{$cCountDataMinOrder}}</b> <i style="color:{{$stCM}}" class="fa fa-check-square"></i> <a href="{{route('getMonthwiseOrderDetails',[$uid,date('m'),Date('Y')])}}" title="View Detail" class="btn btn-outline-primary m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air">
														...
														<div class="m-widget28__tab-item">
															<span>No.of product addition : <b>{{$cCountDataMinProductAddition}}</b> <i style="color:{{$stCMA}}" class="fa fa-check-square"></i> </span>
															<!-- <span>NA</span> -->
														</div>
													</div>
												</div>
							...
							<div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true" data-height="300" style="overflow:hidden; height: 300px">
								...
								<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
									...
									<tbody>
										<?php
										$i = 0;
										$dataArr = DB::table('incentive_payout_percentage')->where('incentive_type_id', 1)->get();
										foreach ($dataArr as $key => $rowData) {
											$i++;
