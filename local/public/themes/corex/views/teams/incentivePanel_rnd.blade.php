...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        $rndHisArr = DB::table('incentive_rnd_history')
            ->where('in_month', date('m'))
        ...
        if ($rndHisArr == null) {
            DB::table('incentive_rnd_history')->insert([
                'circle_type' => 1,
                'name' => date('F') . '-' . date('Y') . ' Incentive',
                                                            ...
                                                            <div class="m-widget5">
                                                                <div class="m-widget5__item">
                                                                    <div class="m-widget5__content">
                                                                        ...
                                                                        <table class="table table-bordered m-table m-table--border-success" id="m_table_RNDIncentive_{{$row['uid']}}">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th>#</th>
                                                                                    <th>Duration</th>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                //echo "<pre>";
                                                                                $dataArrDuration = DB::table('incentive_rnd_history')->orderBy('id', 'desc')->where('in_year', '>', 2021)->get();
                                                                                ...
                                                                                foreach ($dataArrDuration as $key => $rowData) {
                                                                                    ...
                                                                                    $sumInc = DB::table('rnd_incentives_list')
                                                                                        ->where('in_month', intVal($rowData->in_month))
                                                                                        ->where('in_year',  intVal($rowData->in_year))
                                                                                ...
                                                                                ?>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>{{@$sumInc}}</td>
                                                                                        <td>{{$rowData->status==1 ? 'Paid':"Pending"}}</td>
