				...
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title">
						<h3 class="m-portlet__head-text">
							IHNSM:Incentive Details View History: Manger NEW SALES
							: <span style="color:#035496">{{AyraHelp::getUser( Request::segment(2))->name}}</span>
						</h3>
					</div>
				</div>
			</div>
												...
												<div class="m-widget28__tab-item">
													...
													<div class="m-widget28__tab-item">
														...
														foreach ($rootAllMember as $key => $rowDataAx) {
															...
															$ajdata = AyraHelp::getNewOrderAdded($rowDataAx->user_id, $in_month, $in_year);

															echo "<br>" . $rowDataAx->user_id . "-" . $ajdata;
														}
						...
						<div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true" data-height="300" style="overflow:hidden; height: 300px">
							...
							<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
								...
								<tbody>
									<?php
									$i = 0;
									$dataArr = DB::table('incentive_payout_percentage')->where('incentive_type_id', 5)->get();
									foreach ($dataArr as $key => $rowData) {
										$i++;
