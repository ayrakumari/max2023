		...
		<div class="m-portlet">
				...
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title">
						<h3 class="m-portlet__head-text">
							IHG:Incentive Details View History-Growth: <span style="color:#035496">{{AyraHelp::getUser( Request::segment(2))->name}}</span>
						</h3>
					</div>
				</div>
			</div>
			<div class="m-portlet__body">
				...
				$userData = AyraHelp::getUser($uid);
				 $In_month = Request::segment(3);
				 $incentiveCircleType = Request::segment(4);
				...
				<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1_INCDetails">
					...
					<tbody>
						...
						$dataArrDurationData = DB::table('incentive_curr_duration_history')->where('in_month', $In_month)->where('in_year', $In_year)->first();
						...
						$sumOFRejectedAmt = DB::table('payment_recieved_from_client')->where('is_rejected',1)->where('payment_status', 1)->where('created_by', $uid)->whereBetween('recieved_on', [$start_date, $end_date])->where('is_deleted', 0)->sum('rec_amount');
										...
										<div class="m-widget28__tab tab-content">
											<div id="menu11" class="m-widget28__tab-container tab-pane active">
												...
												<div class="m-widget28__tab-item">
														...
														<?php 
														$oderVaL=($oderVaL-$sumOFRejectedAmt);
														?>
														<span>{{$oderVaL}}</span>
													</div>
													<div class="m-widget28__tab-item">
													...
													<div class="m-widget28__tab-item">
															...
															$cRepeatOrderPercentageALL = $cRepeatOrderPercentageALL + AyraHelp::getRepeatOrderPercentageALL($uid, $In_month, $In_year);
															$cRepeatOrderPercentage = $cRepeatOrderPercentage + AyraHelp::getRepeatOrderPercentage($uid, $In_month, $In_year);

															$cPAdditionOrderPercentageALL = $cPAdditionOrderPercentageALL + AyraHelp::getPAdditonPercentageALL($uid, $In_month, $In_year);
															$cPAdditionOrderPercentage = $cPAdditionOrderPercentage + AyraHelp::getPAdditonPercentage($uid, $In_month, $In_year);
														...
														<div class="m-widget28__tab-item">
															<span>Total Payment Collection >= 15K: <b>{{$oderVaL}}</b> <i style="color:{{$stCMA_Groth}}" class="fa fa-check-square"></i> </span>
											...
											<div id="menu11" class="m-widget28__tab-container tab-pane active">
												<div class="m-widget28__tab-items">
													<div class="m-widget28__tab-item">
														...
														<?php
														$incentiveCircleType = 3;
														$oderVaLORI=$oderVaL;
														echo $oderVaL=($oderVaL*83.5)/100;
														$data_ArrInc = AyraHelp::getPayoutDetailByAmount($oderVaLORI, $incentiveCircleType);
							...
							<div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true" data-height="300" style="overflow:hidden; height: 300px">
								...
								<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
									...
									<tbody>
										<?php
										$i = 0;
										$dataArr = DB::table('incentive_payout_percentage')->where('incentive_type_id', 3)->get();
										foreach ($dataArr as $key => $rowData) {
											$i++;
											...
											<div class="m-widget28__tab tab-content">
												<div id="menu11" class="m-widget28__tab-container tab-pane active">
													<div class="m-widget28__tab-items">
														...
														<div class="m-widget28__tab-item">
															<span> {{$userData->name}} 's salary</span>
															<span>
																{{$userData->salary*10}}
																<span class="m-nav__item m-nav__item">
																	<a href="javascript::void(0)" class="m-nav__link" data-toggle="m-tooltip" title="" data-placement="right" data-original-title="Basic Salary: {{$userData->salary}}">
