            ...
            <div class="m-portlet__body">
                <ul class="nav nav-tabs  m-tabs-line m-tabs-line--success" role="tablist">
                    <li class="nav-item m-tabs__item">
                        <a class="nav-link m-tabs__link active" data-toggle="tab" href="#m_tabs_inc_1" role="tab"><i class="la la-cloud-upload"></i>List</a>
                    </li>
                    <li style="display:none" class="nav-item m-tabs__item">
                    ...
                    <li style="display:none" class="nav-item dropdown m-tabs__item">
                                                                            ...
                                                                            <table class="table table-bordered m-table m-table--border-success">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        //$dataArrA = DB::table('incentive_type')->where('id',1)->first();
                                                                                        ...
                                                                                        foreach ($dataArr as $key => $rowData) {
                                                                                            ...
                                                                                            if ($dataArrA->circle_type == 1) {
                                                                                                $dataArrDuration = DB::table('incentive_curr_duration_history')->where('circle_type', $dataArrA->circle_type)->get();
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <a target="_blank" title="View Details" class="btn btn-warning m-btn m-btn--icon btn-sm m-btn--icon-only  m-btn--pill m-btn--air" href="{{route('viewIncentiveEligibilityPanel_History',['uid'=>$row['uid'],$rowData->in_month,$incType,$rowData->in_year])}}">
                                                                                                <i class="fa flaticon-eye"></i>
                                                                                            </a>
