				...
				<form>
					...
					<div class="form-group">
						...
						<select class="form-control m-input" id="assign_user_id">
							...
							$user_role = $userRoles[0];
							?>
							@if ($user_role =="Admin" || Auth::user()->id==3 || Auth::user()->id==40 || Auth::user()->id==4 || Auth::user()->id==119 || Auth::user()->id==129 || Auth::user()->id==90 || Auth::user()->id==130 || Auth::user()->id==131 || Auth::user()->id==134 || Auth::user()->id==144 || Auth::user()->id==145 || Auth::user()->id==141 ||  Auth::user()->id==221)
							@foreach (AyraHelp::getSalesAgentAdmin() as $user)
