          ...
          <div class="m-content">
          	...
          	<div class="m-portlet m-portlet--mobile">
          		...
          		<div class="m-portlet__body">
          			...
          			<form class="m-form m-form--fit m--margin-bottom-0">
          				<div class="row m--margin-bottom-5">
          					<div class="col-lg-2 m--margin-bottom-1-tablet-and-mobile">
          						...
          						<input type="text" class="form-control m-input" placeholder="Company" data-col-index="2">
          					</div>
          			...
          			<!--begin: Datatable -->
          			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_PaymentRequestLIST_sample">
          				<thead>
          					<tr>
          						<th>SN#</th>
          						<th>Payment Date</th>
          ...
          <div class="modal fade" id="m_modal_6PAYMENTRECDETAIL_SAMPLE" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal fade" id="m_modal_6PAYMENTRECDETAIL_HIST_SAMPLE" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          	<div class="modal-dialog modal-lg" role="document">
          		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          			<span aria-hidden="true">&times;</span>
          		</button>
          		...
          		<div class="modal-content">
          			<div class="modal-body">
          				<div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true" data-height="450">
          					<div id="payDetalRecSHOW_HIST_SAMPLE">
          	...
          	<div class="modal-dialog modal-sm" role="document">
          		<div class="modal-content">
          			...
          			<div class="modal-footer">
          				...
          				<button type="button" id="btnPayRecSubmitSample" class="btn btn-primary">Submit message</button>
          			</div>
          		</div>
          	</div>
          </div>
