        ...
        <div class="m-portlet__body">
           ...
           // print_r($data);
            ...
            <form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form_add_client" method="post" action="{{ route('saveNewLead')}}">
                @csrf
                <input type="hidden"  name="leadID" value="{{$data->QUERY_ID}}">
                <div class="m-portlet__body">
                    <div class="m-form__section m-form__section--first">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">* Company:</label>
                                <input type="text" class="form-control m-input" name="company" value="{{$data->GLUSR_USR_COMPANYNAME}}" placeholder="Enter Company">
                            </div>
                            <div class="col-lg-4 m-form__group-sub">
                    ...
                    <div class="m-form__section m-form__section--first">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4 m-form__group-sub">
                                ...
                                <input type="text" class="form-control m-input" name="name" value="{{$data->SENDERNAME}}" placeholder="Enter Name">
                            </div>
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">*Phone:</label>
                                <input id="m_inputmask_6" type="text" class="form-control m-input"  value="{{$data->MOB}}" name="phone" placeholder="Enter Phone">
                            </div>
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label"> Email:</label>
                                <input type="text" class="form-control m-input" name="email" value="{{$data->SENDEREMAIL}}"  placeholder="Enter Email">
                            </div>
                        </div>
                    </div>
                    <!-- name email phone -->
                    ...
                    <div class="m-form__section m-form__section--first">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4 m-form__group-sub">
                                ...
                                <input type="text" class="form-control m-input" value="{{$data->ENQ_ADDRESS}}"  name="address" placeholder="Enter Address">
                            </div>
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">Location:</label>
                                <input type="text" class="form-control m-input" value="{{$data->ENQ_CITY}},{{$data->ENQ_STATE}}" name="location" placeholder="Enter Location">
                            </div>
                            <div class="col-lg-4 m-form__group-sub">
                    ...
                    <div class="m-form__section m-form__section--first">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                ...
                                <input type="text" class="form-control m-input" value="{{$data->ENQ_MESSAGE}}" name="remarks" placeholder="Enter Remarks">
                            </div>
                            <div class="col-lg-4 m-form__group-sub">
