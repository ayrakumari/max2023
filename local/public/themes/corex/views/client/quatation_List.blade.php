...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
          ...
          <div class="m-portlet__head-tools">
             <ul class="m-portlet__nav">
                  <li class="m-portlet__nav-item">
                        <a href="{{route('addNew_Quotation')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
                        <span>
       ...
       <div class="m-portlet__body">
          ...
          <!-- form  -->
<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_quatationDataList">
				<thead>
					<tr>						
						<th>ID</th>
						<th>QID</th>
