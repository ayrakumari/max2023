...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
				...
				<div class="m-portlet__head-title">
					...
					<!-- <table style="margin-left:30px;">
																		<tr>
																			...
																			<td>
																			a		<button type="button" class="btn btn-outline-default btn-sm"> 15 Days <span class="m-badge m-badge--danger">{{  $spcount=AyraHelp::samplePendingDispatch(15)}}</span></button> 
																			</td>
																		</tr>
																	</table> -->
				</div>
			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					<li class="m-portlet__nav-item">
						...
						if ($user_role == 'SalesUser' || $user_role == 'User' || Auth::user()->id==202 || Auth::user()->id==217 ) {

						} else {
						?>
							<a href="{{route('addFinishProduct')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
								<span>
							...
							<a href="{{route('exportExcelFinishProduct')}}" class="btn btn-warning m-btn m-btn--custom m-btn--icon">
								<span>
									<i class="la la-plus"></i>
									<span>Export</span>
								</span>
		...
		<div class="m-portlet__body">
			<form class="m-form m-form--fit m-form--label-align-right ajfileupload" action="{{ route('importFinishProduct') }}" method="POST" enctype="multipart/form-data">
				<div class="m-portlet__body">
					@csrf
					<div class="row">
						<div class="col-md-12">
							<div class="form-group m-form__group">
								...
								<div class="custom-file">
									<input type="file" name="m_csvfile" class="custom-file-input" id="customFile">
				...
				<div class="row m--margin-bottom-20">
					...
					<div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
						...
						<select class="form-control m-input" data-col-index="2">
							...
							<?php
							$ing_arr = AyraHelp::getFNDIngredientCategory();
							foreach ($ing_arr as $key => $rowData) {
							?>
								<option value="{{$rowData->cat_name}}">{{$rowData->cat_name}}</option>
							<?php
							}
					...
					<div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
						...
						<select class="form-control m-input" data-col-index="3">
							<option value="">-SELECT-</option>
							<?php
							$ing_arr = AyraHelp::getFNDIngredientSubCategory();
							foreach ($ing_arr as $key => $rowData) {
							?>
								<option value="{{$rowData->sub_cat_name}}">{{$rowData->sub_cat_name}}</option>
							<?php
							}
			...
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_RND_finishProductList">
				<thead>
					<tr>
						<th>ID#</th>
						<th>Name</th>
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_ViewFinishPRDetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Finish Product Detail</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<input type="hidden" id="txtFPID">
				<div class="clsFPDetails">
				</div>
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_FPLISt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Selling Price Range/ Kg</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<input type="hidden" id="txtPFSPMinMax">
				<div class="form-group">
					<label for="recipient-name" class="form-control-label">Min SP:</label>
					<input type='text' class="form-control" id="m_inputmask_6" name="txtSPMin" type="text" />
				</div>
				<div class="form-group">
					<label for="recipient-name" class="form-control-label">Max SP:</label>
					<input type='text' class="form-control" id="m_inputmask_6A1" name="txtSPMax" type="text" />
				</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="btnSaveSPRange">Save Now</button>
			</div>
		</div>
	</div>
</div>
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_4ING_DETAILBrand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Ingredent Brand Details</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
