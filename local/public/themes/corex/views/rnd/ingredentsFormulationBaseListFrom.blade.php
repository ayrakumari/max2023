        ...
        <div class="m-portlet__body">
            ...
            <form class="m-form m-form--fit m--margin-bottom-20" style="display:none ;">
                <div class="row m--margin-bottom-20">
                    ...
                    <div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
                        <label>Status:</label>
                        <select id="catIDPrice" class="form-control m-input" data-col-index="7">
                    ...
                    <div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
                        ...
                        <select id="catIDPrice" class="form-control m-input" data-col-index="6">
                            <option value="">-SELECT-</option>
                            <?php
            ...
            <!--begin: Datatable -->
            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_Base_RNDFormulationFrom" style="display: ;">
                <thead>
                    <tr>
                        <th>ID#</th>
                        <th>Formula Name</th>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" id="btnFormulaBatchPrintBase" class="btn btn-primary">Submit</button>
							...
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<button type="button" id="btnRNDStatusUpdateBase" class="btn btn-primary">Submit</button>
									</div>
								</div>
							</div>
						</div>
