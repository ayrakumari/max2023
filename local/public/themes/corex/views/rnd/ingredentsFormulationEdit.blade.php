...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            <form id="btnSaveFormuationRND" class="m-form m-form--fit m-form--label-align-right m-form" action="{{route('saveEditFormulaRND')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3" style="visibility: hidden;">
                            <label>*MFG QTY(gm):</label>
                            <input id="m_inputmask_67" type="text" name="txtMFGQTY" style="background-color:grey;color:#f1f1f1;" class="form-control m-input" placeholder="">
