														...
														<div class="m-portlet__head-tools">
															<ul class="m-portlet__nav">
																<li class="m-portlet__nav-item">
																	...
																	<a href="{{route('IngredentBrandAddNew')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
																		<span>
	...
	<div class="row m--margin-bottom-20">
		...
		<div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
			...
			<select class="form-control m-input"   data-col-index="1">
					...
					<?php
					$ing_arr=AyraHelp::getIngredientBrand();
					foreach ($ing_arr as $key => $rowData) {
					  ?>
					  <option  value="{{$rowData->brand_name}}">{{$rowData->brand_name}}</option>
					  <?php
					}
...
<!--stop: Search Form --> 
  ...
  <input type="hidden" id="txtSampleAction" value="show_all">
														...
														<!--begin: Datatable -->
														<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_IngredentBrandList">
															<thead>
																<tr>
																	<th>ID#</th>
																	<th>Brand Name</th>
