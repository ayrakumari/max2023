...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        ...
                        $bo_formuation = DB::table('bo_formuation_v1')
                            ->where('id', $fid)
                            ->first();

                        $bo_formuation_child = DB::table('bo_formuation_child_v1')
                            ->where('fm_id', $fid)
                            ->get();

                        $bo_formuation_child_process = DB::table('bo_formuation_child_process_v1')
                        ->where('fm_id', $fid)
        ...
        <div class="m-portlet__body">
            ...
            <form id="btnSaveFormuationRND" class="m-form m-form--fit m-form--label-align-right m-form" action="{{route('saveEditFormulaRNDv1')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" value="{{@$bo_formuation->base_code}}" name="txtBaseCode"   class="form-control m-input" placeholder="">
