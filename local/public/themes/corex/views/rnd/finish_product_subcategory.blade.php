													...
													<div class="m-portlet__head">
														<div class="m-portlet__head-caption">
															<div class="m-portlet__head-title">
																...
																Finish Product Sub Category List
																</h3>
														...
														<div class="m-portlet__head-tools">
															<ul class="m-portlet__nav">
																<li class="m-portlet__nav-item">
																	...
																	<a href="{{route('add_finish_product_subcat')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
																		<span>
...
<div class="m-portlet__body">  
  ...
  <input type="hidden" id="txtSampleAction" value="show_all">
														...
														<!--begin: Datatable -->
														<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_finishproduct_subcatlistData">
															<thead>
																<tr>
																	<th>ID#</th>
                                  <th>Sub Category</th>
