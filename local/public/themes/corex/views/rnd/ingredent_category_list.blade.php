														...
														<div class="m-portlet__head-tools">
															<ul class="m-portlet__nav">
																<li class="m-portlet__nav-item">
																	...
																	<a href="{{route('IngredentAddIngCat')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
																		<span>
...
<!--stop: Search Form -->  
  ...
  <input type="hidden" id="txtSampleAction" value="show_all">
														...
														<!--begin: Datatable -->
														<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_IngredentCategoryList">
															<thead>
																<tr>
																	<th>ID#</th>
																	<th>Category Name</th>
																	<th>Brand Available</th>
                                                                    <th>No. Ingredient</th>
                                                                    <th>No. Formulation</th>
																	<th>No. Finish Product </th>																																	
																	<th>Actions</th>
																</tr>
															</thead>															
														</table>
							...
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">Ingredent Category  Details</h5>
