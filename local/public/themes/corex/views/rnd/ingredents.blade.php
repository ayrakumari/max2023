...
<div class="m-content">
			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					<li class="m-portlet__nav-item">
						<?php 
						if(Auth::user()->id==1 || Auth::user()->id==156 || Auth::user()->id==124){
							?>
	<a href="{{route('addIngredetnView')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
					...
					<li class="m-portlet__nav-item">
					<a href="{{route('sapUploadFile')}}" class="btn btn-accent m-btn m-btn--custom m-btn--icon">
						<span>
		...
		<div class="m-portlet__body">
			...
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_Ingredients">
				<thead>
					<tr>
						<th>ID#</th>
