     ...
     // print_r($data);
      ...
      <div class="m-portlet__body">
         <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">          
            <form data-redirect="{{route('rnd.finishProduct')}}" class="m-form m-form--state m-form--fit m-form--label-align-right"   id="m_form_add_ingredeint" method="post" action="{{ route('EditFinishProduct')}}">
               @csrf
               <?php 
                        ...
                        ?>
              <input type="hidden" name="txtPDID" id="" value="{{$data->id}}" >
               ...
               <div class="m-portlet__body">
                  <div class="m-form__section m-form__section--first">
                     <div class="form-group m-form__group row">
                        <div class="col-lg-3 m-form__group-sub">
                            ...
                            <input type="text" value="{{$data->product_name}}" class="form-control m-input" id="finish_p_name" name="finish_p_name" placeholder="">
                        </div>
                        <div class="col-lg-3 m-form__group-sub">
                           ...
                           <select name="finish_p_catid" id="finish_p_catid" class="form-control m-input">
                              ...
                              foreach ($car_data_arr as $key => $value) {
                                if($value->id==$data->cat_id){
                                 ?>
                                 <option selected value="{{$value->id}}">{{$value->sub_cat_name}}</option>
                        ...
                        <div class="col-lg-3 m-form__group-sub">
                            ...
                            <select name="finish_p_grade" id="finish_p_grade" class="form-control m-input">
                                <option value="">--SELECT--</option>
                                <option <?php echo $data->grade_id==1 ? "selected":""?> value="1">Premium</option>
                                <option <?php echo $data->grade_id==2 ? "selected":""?> value="2">Standard</option>
                                <option <?php echo $data->grade_id==3 ? "selected":""?> value="3">Regular</option>
                            </select>
                        </div>
                        <!-- <div class="col-lg-3 m-form__group-sub">
                            <label class="form-control-label">* SAP SFG ID:</label>
                            <input type="text" value="{{$data->sap_code}}"  class="form-control m-input" id="finish_p_sap_code" name="finish_p_sap_code" placeholder="">
                        </div> -->
                  ...
                  <div class="m-form__section m-form__section--first">
                     <div class="form-group m-form__group row">                       
                        <div class="col-lg-12 m-form__group-sub">
                            ...
                            <textarea name="finish_p_ingredient"   id="finish_p_ingredient" class="form-control" data-provide="markdown" rows="5">{{$data->ingredents_details}}</textarea>
                        </div>
                              ...
                              <div class="form-group  m-form__group row">
                                 ...
                                 <div data-repeater-list="sizeRateArrA" class="col-lg-12">
                                    ...
                                    <div data-repeater-item class="row m--margin-bottom-10">
                                       <div class="col-lg-6">
                                          <div class="input-group">
                                             <input type="number" class="form-control m-input"  value="{{$data->size_1}}" name="rndSizeWith_1" placeholder="Size">
                                       ...
                                       <div class="col-lg-6">
                                          <div class="input-group">
                                             ...
                                             <input type="number" class="form-control m-input" value="{{$data->price_1}}" name="rndRateWith_1" placeholder="Rate">
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div data-repeater-item class="row m--margin-bottom-10">
                                       <div class="col-lg-6">
                                          <div class="input-group">
                                             <input type="number" class="form-control m-input" value="{{$data->size_2}}"  name="rndSizeWith_2" placeholder="Size">
                                             <div class="input-group-append">
                                                <span class="input-group-text">KG</span>
                                             </div>
                                          </div>
                                       ...
                                       <div class="col-lg-6">
                                          <div class="input-group">
                                             ...
                                             <input type="number" class="form-control m-input" value="{{$data->price_2}}" name="rndRateWith_2" placeholder="Rate">
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div data-repeater-item class="row m--margin-bottom-10">
                                       <div class="col-lg-6">
                                          <div class="input-group">
                                             <input type="number" class="form-control m-input" value="{{$data->size_3}}" name="rndSizeWith_3" placeholder="Size">
                                             <div class="input-group-append">
                                                <span class="input-group-text">KG</span>
                                             </div>
                                          </div>
                                       ...
                                       <div class="col-lg-6">
                                          <div class="input-group">
                                             ...
                                             <input type="number" class="form-control m-input" value="{{$data->price_3}}" name="rndRateWith_3" placeholder="Rate">
                                          </div>
                                       </div>
                                    </div>
                  ...
                  <!-- <div class="m-form__section m-form__section--first">
                     <div class="form-group m-form__group row">
                        ...
                        <?php 
                        if(Auth::user()->id ==1 || Auth::user()->id==103 || Auth::user()->id==84){
                           ?>
                           <div class="col-lg-4 m-form__group-sub">
                            <label class="form-control-label">Cost Price /Kg:</label>
                           <input type="text" value="{{$data->cost_price}}"  class="form-control m-input" id="finish_p_cost_price" name="finish_p_cost_price" placeholder="">
                           </div>
                           <?php
                        }
                        ...
                        <div class="col-lg-8 m-form__group-sub">
                           ...
                           <div class="input-group">
                           <textarea name="finish_p_benifit_claim" class="form-control" data-provide="markdown" rows="3"> {{$data->benifit_claim}}</textarea>
                           </div>
                        </div>
                     </div>
                  </div> -->
