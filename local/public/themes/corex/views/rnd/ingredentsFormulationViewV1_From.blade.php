    ...
    <div class="m-portlet m-portlet--mobile" style="display:#">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        ...
                        // echo "<pre>";
                        // print_r($data);
                        $boFormulaChildArr = DB::table('base_bo_formuation_child_From')
                            ->where('fm_id', $data->id)
                            ->get();
                            $boFormulaChildArrUniq = DB::table('base_bo_formuation_child_From')
                            ->where('fm_id', $data->id)    
                            ->orderBy('phase', 'asc')          
                            ->distinct()              
                            ->get('phase');
                        $boFormulaChildProcessArr = DB::table('base_bo_formuation_child_process_From')
                            ->where('fm_id', $data->id)
                            ->get();

                        // $boFormulaChildArrSum = DB::table('base_bo_formuation_child_From')
                        //     ->where('fm_id', $data->id)
                        //     ->sum('mfg_pecentage');
                            $boFormulaChildArrSum="";
        ...
        <div class="m-portlet__body">
            ...
            <div id="div_printmeRND">
                ...
                <table cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left">{{$data->formula_name}}</td>
                        ...
                        <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left">{{$data->fm_code_base}}</td>
                    </tr>
                    <tr>
                        <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" height="17" align="left"><b>Base Code</b></td>
                        <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left">{{@$data->base_code}}</td>
           ...
           foreach ($boFormulaChildArrUniq as $key => $rowData) {
            ...
            $boFormulaChildProcessArrChild = DB::table('base_bo_formuation_child_process_From')
            ->where('fm_id', $data->id)
          ...
          ?>
                    ...
                    <tr>
                        ...
                        <!-- <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center">{{$boFormulaChildArrSum}}4</td> -->
