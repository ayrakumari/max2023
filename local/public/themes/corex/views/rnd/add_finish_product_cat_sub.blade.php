      ...
      <div class="m-portlet__body">
         <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">   
           ...
           <div class="row">
                ...
                <form data-redirect="{{route('finishProductCategory')}}" class="m-form m-form--state m-form--fit m-form--label-align-right"   id="m_form_add_ingredeint_v2" method="post" action="{{ route('saveFinishCatSubCat')}}">
               @csrf
               <input type="hidden" name="txtCVal" value="1">
               ...
               <div class="m-portlet__body">
                  <div class="m-form__section m-form__section--first">
                     <div class="form-group m-form__group row">
                        ...
                        <input type="text"  class="form-control m-input" id="f_p_cat" name="f_p_cat" placeholder="">
                        </div>
               ...
               <div class="m-portlet__foot m-portlet__foot--fit">
                  <div class="m-form__actions m-form__actions">
                     <div class="row">
                        <div class="col-lg-12">
                           <button type="submit" data-wizard-action="submitSaveINGD_v2" class="btn btn-primary ajsaveIngdredent">Save Catgory</button>                           
                ...
                <form data-redirect="aba.html"  style="display:none" class="m-form m-form--state m-form--fit m-form--label-align-right"   id="m_form_add_ingredeint_v1" method="post" action="{{ route('saveFinishCatSubCat')}}">
               @csrf
                <?php 
