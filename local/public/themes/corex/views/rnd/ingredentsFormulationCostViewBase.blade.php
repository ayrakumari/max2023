            ...
            <div id="div_printmeRND">
                ...
                <table cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td width="160px" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="right"><b></b></td>
                        <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="right"><b>Cost</b></td>
                    ...
                    foreach ($boFormulaChildArrUniq as $key => $rowData) {
                        ...
                        $boFormulaChildProcessArrChild = DB::table('base_bo_formuation_child_process')
                            ->where('fm_id', $data->id)
                            ...
                            <td colspan="3" align="center" valign=middle>
                                <table cellspacing="0" border="1">
                                    ...
                                    foreach ($boFormulaChildArr as $key => $rowChild) {
                                        ...
                                        $d_cost=($rowChild->dos_percentage*$rowChild->price)/100;
                                        $costAmtTot=$costAmtTot+$d_cost;
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="center" valign=middle>
                            <table cellspacing="0" border="1">
                                ...
                                <tr>
                                    <td height="50" align="right" width="350px">
                                        SUM
                                    </td>
                                    <td align="center" width="40px">
                                        {{$totV}}
