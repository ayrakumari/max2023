...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            <form id="btnSaveFormuationRND" class="m-form m-form--fit m-form--label-align-right m-form" action="{{route('saveFormulaRND_Base')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-primary" style="background-color:#f1f1f1;">
                        ...
                        <tbody>
                            <tr>
                                <th width="350px">
                                    ...
                                    <select class="form-control m-select2 txtBaseFMCode" id="m_select2_1" name="txtBaseFMCode">
                                    <?php 
                                    
                                    $bo_formuation_v1ArrData = DB::table('bo_formuation_v1')                                    
                                    ->get();
                                    foreach ($bo_formuation_v1ArrData as $key => $rowData) {
                                       ?>
                                       <option value="{{$rowData->id}}">{{$rowData->fm_code}}</option>                                       
                                       <?php
                                    }
                                    ?>
                                    </select>
                                ...
                                <td width="100px">
                                    <input type="text" id="m_inputmask_6" name="txtDose_v1" class="form-control m-input" placeholder="">
                                </td>
                                ...
                                <td>
                                    <input type="text" name="txtIPrice_v1" class="form-control m-input" placeholder="">
                                </td>
                                <td width="180px">
                                    <input type="text" readonly id="txtRNDCost_v1" name="txtRNDCost_v1" class="form-control m-input" placeholder="">
                                </td>
                                <td>
                                    <a href="#" style="margin-top: 1px;" class="add_field_buttonFormualtionBaseV1 btn btn-warning btn-sm m-btn 	m-btn m-btn--icon">
                                        <span>
                                           ADD 
                    ...
                    <table class="table table-bordered m-table m-table--border-primary m-table--head-bg-success" style="background-color:#f1f1f1;">
                        ...
                        <tbody class="input_fields_wrapFormulationBase_v1">
                ...
                <!-- base  -->
                    <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-primary" style="background-color:#f1f1f1;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="#" style="margin-top: 1px;" class="add_field_buttonFormualtionBase btn btn-primary btn-sm m-btn 	m-btn m-btn--icon">
                                        <span>
                                           ADD 
                    ...
                    <table class="table table-bordered m-table m-table--border-primary m-table--head-bg-success" style="background-color:#f1f1f1;">
                        ...
                        <tbody class="input_fields_wrapFormulationBase">
                    ...
                    <table style="display: none;" class="table table-striped m-table" style="background-color:#f1f1f1;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <b>Total Dose:</b> <span id="txtPView">(gms)</span>
                                </td>
                                <td width="83px">
                                </td>
                                <td>
                    ...
                    <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand ">
                        ...
                        <tbody class="ajphaseProcessClassBase">
                    ...
                    <div id="textdiv" class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                        <div class="m-form__actions m-form__actions--solid">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <button type="submit" class="btn btn-primary submitViewBase">Submit</button>
