...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Copy and Add Base  Formulations
                    </h3>
        ...
        <div class="m-portlet__body">
            ...
            <form id="btnSaveFormuationRND" class="m-form m-form--fit m-form--label-align-right m-form" action="{{route('saveEditCopyFormulaRNDBaseV1')}}" method="post" enctype="multipart/form-data">
                @csrf
