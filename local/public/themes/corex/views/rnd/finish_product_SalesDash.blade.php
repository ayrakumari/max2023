														...
														<div class="m-portlet__head-tools">
															<ul class="m-portlet__nav">
																...
																<?php
																 ...
																 if($user_role=='SalesUser' || Auth::user()->id==202 || Auth::user()->id==217 ){
	...
	<div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
			...
			<select class="form-control m-input"   data-col-index="2">
					...
					foreach ($ing_arr as $key => $rowData) {
					  ?>
					  <option  value="{{ucwords(strtolower($rowData->cat_name))}}">{{ucwords(strtolower($rowData->cat_name))}}</option>
					  <?php
					}
		...
		<div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
			...
			<select class="form-control m-input"   data-col-index="3">
					...
					foreach ($ing_arr as $key => $rowData) {
					  ?>
					  <option  value="{{ucwords(strtolower($rowData->sub_cat_name))}}">{{ucwords(strtolower($rowData->sub_cat_name))}}</option>
					  <?php
					}
...
<!--stop: Search Form -->  
  ...
  <input type="hidden" id="txtSampleAction" value="show_all">
														...
														<!--begin: Datatable -->
														<table class="table table-striped- table-bordered table-hover table-checkable ajayra" id="m_table_RND_finishProductList_salesDash">
															<thead>
															<tr>
																	<th>ID#</th>
																	<th>Name</th>																	
