														...
														<div class="m-portlet__head-tools">
															<ul class="m-portlet__nav">
																<li class="m-portlet__nav-item">
																	...
																	<a href="{{route('NewProductProductDevlopment')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
																		<span>
...
<form class="m-form m-form--fit m--margin-bottom-20">
	<div class="row m--margin-bottom-20">
		...
		<div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
			...
			<select class="form-control m-input"   data-col-index="6">
				<option  value="">--ALL--</option>
				<?php
					$ing_arr=AyraHelp::getRNDStageNOW();
					foreach ($ing_arr as $key => $rowData) {
					  ?>
					  <option  value="{{$rowData->stage_name}}">{{$rowData->stage_name}}</option>
					  <?php
					}
  ...
  <input type="hidden" id="txtSampleAction" value="show_all">
														...
														<!--begin: Datatable -->
														<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_new_product_list">
															<thead>
																<tr>
																	<th>ID#</th>
																	<th>Create Date</th>
