			...
			<div class="m-portlet__head">
				<div class="m-portlet__head-tools">
					<ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x m-tabs-line--right" role="tablist">
						...
						<div class="m-portlet__head-tools" style="visibility:hidden;">
						...
						<form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form_3_salesInvoiceRequest">
							...
							<div class="form-group m-form__group row">
								<div class="col-lg-4 m-form__group-sub">
									...
									<select class="form-control m-select2 client_name_qcformSIR" id="m_select2_1" name="client_id">
								...
								<div class="col-lg-2 m-form__group-sub">
									...
									<input type="text" name="txtMyContactNO" id="txtMyContactNO" class="form-control" placeholder="Contact No" />
								</div>
								...
								<div class="col-lg-3 m-form__group-sub">
									...
									<select class="form-controlm-select2 myOrderListSelectA" name="formNO" id="myOrderListSelectA">
							...
							<div class="form-group m-form__group row">
								<div class="col-lg-6 m-form__group-sub">
									...
									<input type="text" name="txtPONUM" class="form-control m-input" placeholder="Enter PO Number">
								</div>
								<div class="col-lg-6 m-form__group-sub">
									<label class="form-control-label">* PO Date </label>
									<input type="text" name="txtPONUM_Date" class="form-control" id="m_datepicker_1_stE" readonly="" placeholder="Select date">
