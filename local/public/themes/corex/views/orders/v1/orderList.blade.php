    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
           ...
           <button type="button" class="btn btn-danger btn-arrow-right">Production</button>
                ...
                <div class="row m--margin-bottom-20">
                    <div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
                        ...
                        <select class="form-control m-input" data-col-index="7">
                            ...
                            ?>
                            @if ($user_role =="Admin" || $user_role =="SalesHead" || Auth::user()->id==91 || Auth::user()->id==88)
                ...
                <div class="col-md-12">
                    <div class="m-form__group form-group">
                        ...
                        <div class="m-radio-inline">
                            <label class="m-radio">
                                <input type="radio" name="stay_from" value="1"> ASC
                                <span></span>
                            </label>
                            <label class="m-radio">
                                <input type="radio" name="stay_from" value="2"> DESC
                                <span></span>
                            </label>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable ajayra" id="m_table_QCFORMList_v1OrderList">
                <thead>
                    <tr>
                        <th>ID#</th>
                        <th>ORDER ID</th>
...
<div class="modal fade" id="m_modal_orderAddNotesModelPrint" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Notes for QC PRINT</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btnSubmitNoteOrderPrint">Save & Print QC</button>
            </div>
        </div>
    </div>
</div>
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_4_ViewOrderDetailRequest" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Order Detail Modify</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" style="background-color:#035496;">
                <!-- data form  -->
                <form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form_add_qcformModifyRequest" method="post" action="{{ route('saveQCdataPricePart')}}">
                    @csrf

                    <div class="m-portlet__body">
                        <div class="m-form__section m-form__section--first">
                            <div class="form-group m-form__group row">
                                <input type="hidden" readonly class="form-control m-input" id="order_idModify" name="order_idModify" placeholder="Order No.">

                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" class="form-control-label">Size :</label>
                                    <div class="input-group">
                                        <input type="text" name="item_size" class="form-control" id="item_size" />
                                    </div>
                                </div>

                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" class="form-control-label">UNIT :</label>
                                    <div class="input-group">
                                        <input type="text" name="itemSizeUnitModify" class="form-control" id="itemSizeUnitModify" />
                                    </div>
                                </div>
                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" class="form-control-label">QTY :</label>
                                    <div class="input-group">
                                        <input type="text" name="item_qty" class="form-control" id="item_qty" />
                                    </div>
                                </div>

                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" title="Row Material Price per Kg" class="form-control-label">RM Price/Kg:</label>
                        ...
                        <div style="display:block;" class="m-form__section m-form__section--first" style="background-color: #c1c1c1;">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" title="Price of Bottle/Jar/Cap" class="form-control-label">Bottle/Cap/Pump:</label>
                                ...
                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" title="Price of Label" class="form-control-label"> Label Price:</label>
                                ...
                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" class="form-control-label">M.Carton Price:</label>
                                ...
                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" class="form-control-label">L & C Price:</label>
                        ...
                        <div style="display:block;" class="m-form__section m-form__section--first" style="background-color: #c1c1c1;">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" class="form-control-label">Margin:</label>
                                    <input title="Enter Margin" type="number" class="form-control m-input" id="item_Margin_Price" name="item_Margin_Price" placeholder="">
                                </div>

                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" class="form-control-label">S.P:</label>
                                    <input readonly title="Enter Margin" type="number" class="form-control m-input" id="item_selling_price" name="item_selling_price" placeholder="">
                                </div>

                                <div class="col-lg-3 m-form__group-sub">
                                    <label style="color:#f1f1f1" class="form-control-label">Order values:</label>
                                    <input readonly title="Enter Margin" type="number" class="form-control m-input" id="order_value" name="order_value" placeholder="">
                                </div>



                                <div class="col-lg-9 m-form__group-sub">
                                    <label style="color:#f1f1f1" title="Price of Label" class="form-control-label"> Remarks:</label>
                                    <textarea class="form-control m-input" id="orderModifyRemarks" name="orderModifyRemarks" rows="1"></textarea>
                                </div>
...
<div class="modal fade" id="m_modal_orderEditRequest" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        <div class="modal-content">
            <div class="orderDetailsViD"></div>
            <div class="modal-body">
                <!--begin::Form-->

                <form class="m-form" id="m_orderEDITREQ" action="{{route('saveOrderEditREQ')}}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="txtFOMID" id="txtFORMI">
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group">
                            <label for="example_input_full_name">Request Type :</label>
                            <select name="orderReqType" class="form-control m-input">
                                <option value="">Select</option>
                                <?php
                                $dataArr = DB::table('order_edit_type')
                                    ->where('is_active', 1)
                                    ->get();
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <textarea class="form-control m-input" id="exampleTextarea" name="txtRemarkEDITREQ" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="m-portlet__foot m-portlet__foot--fit">
