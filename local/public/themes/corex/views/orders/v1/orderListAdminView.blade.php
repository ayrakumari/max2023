    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
           ...
           <button type="button" class="btn btn-danger btn-arrow-right">Production</button>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable ajayra" id="m_table_QCFORMList_v1OrderListAdminView">
                <thead>
                    <tr>
                        <th>ID#</th>
                        <th>ORDER ID</th>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="m-portlet m-portlet--warning m-portlet--head-solid-bg">
                            ...
                            <?php
                            if (Auth::user()->id == 1 || Auth::user()->id == 90 || Auth::user()->id == 171 || Auth::user()->id == 85  ) {
                            ?>
