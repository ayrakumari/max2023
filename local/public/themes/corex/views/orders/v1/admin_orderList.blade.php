...
.btn-arrow-left:after {
  ...
  background-color: white;
           ...
           <button type="button" class="btn btn-danger btn-arrow-right">Production</button>
									...
									<div class="row m--margin-bottom-20">
										<div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
											...
											<select class="form-control m-input"   data-col-index="7">
                                                ...
                                                ?>
                                               	@if ($user_role =="Admin" || $user_role =="SalesHead" || Auth::user()->id==91)
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_QCFORMList_v1OrderList">
                    <thead>
                        <tr>
                            <th>ID#</th>
                            <th>ORDER ID</th>                            
