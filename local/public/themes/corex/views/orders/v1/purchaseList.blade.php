...
<form class="m-form m-form--fit m--margin-bottom-20">
    <div class="row m--margin-bottom-20">
      <div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
        ...
        <input type="text" class="form-control m-input" placeholder="Enter Item Name" data-col-index="2">
      </div>
      <div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
      ...
      <div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
        ...
        <input type="text" class="form-control m-input" placeholder="Item Name" data-col-index="5">
      </div>
      <div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
  ...
  <input hidden type="text" id="txtNumberofdays">
                                    ...
                                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_QCFORMPurchaseListBOV1">
                                        <thead>
                                            <tr>
                                                <th>ID#</th>        
                                                <th>BOM</th>                                                  
...
<?php /*
                        ...
                        <div class="m-portlet__body">
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_QCFORMPurchaseListBOV1_AJ">
                                        <thead>
                                            <tr>
                                                <th>ID#</th>        
                                                <th>BOM</th>                                                  
