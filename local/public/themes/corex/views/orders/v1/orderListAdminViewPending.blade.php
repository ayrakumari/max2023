    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
           ...
           <button type="button" class="btn btn-danger btn-arrow-right">Production</button>
                ...
                <div class="row m--margin-bottom-20">
                    <div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
                        ...
                        <select class="form-control m-input" data-col-index="7">
                            ...
                            ?>
                            @if ($user_role =="Admin" || $user_role =="SalesHead" || Auth::user()->id==91 || Auth::user()->id==88 || Auth::user()->id==89 ||  Auth::user()->id==147 || Auth::user()->id==196 || Auth::user()->id==212 || Auth::user()->id==219)
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable ajayra" id="m_table_QCFORMList_v1OrderListAdminViewPending">
                <thead>
                    <tr>
                        <th>ID#</th>
                        <th>ORDER ID</th>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="m-portlet m-portlet--warning m-portlet--head-solid-bg">
                            ...
                            <?php
                            if (Auth::user()->id == 1 || Auth::user()->id == 90 || Auth::user()->id == 171 || Auth::user()->id == 185  ) {
                            ?>
                                ...
                                <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> RM Price/Kg: </td>
                                            <td>
                                                <input id="item_RM_Price" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                            ...
                                            <td>
                                                <input id="item_BCJ_Price" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input" aria-describedby="emailHelp">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">3</th>
                                            <td> Label Price: </td>
                                            <td>
                                                <input id="item_Label_Price" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="item_Material_Price" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">5</th>
                                            <td>L & C Price: </td>
                                            <td>
                                                <input id="item_LabourConversion_Price" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">6</th>
                                            <td>Margin: </td>
                                            <td>
                                                <input id="item_Margin_Price" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>Size:</td>
                                            <td>
                                                <input id="item_size" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>QTY:</td>
                                            <td>
                                                <input id="item_qty" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>Selling Price:</td>
                                            <td>
                                                <input id="item_selling_price" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">9</th>
                                            ...
                                            <td>
                                                <input id="order_value" type="text" style="width: 115px;background-color:#035496;color:#FFFF" class="form-control form-control-sm m-input"  aria-describedby="emailHelp">
                                            </td>
                                        </tr>
