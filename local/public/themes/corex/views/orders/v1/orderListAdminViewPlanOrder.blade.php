    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
           ...
           <button type="button" class="btn btn-danger btn-arrow-right">Production</button>
                ...
                <div class="row m--margin-bottom-20">
                    <div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
                        ...
                        <select class="form-control m-input" data-col-index="7">
                            ...
                            ?>
                            @if ($user_role =="Admin" || $user_role =="SalesHead" || Auth::user()->id==91 || Auth::user()->id==88 || Auth::user()->id==89 ||  Auth::user()->id==147 || Auth::user()->id==196)
                            @foreach (AyraHelp::getSalesAgentAdminNotDeleted() as $user)
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable ajayra" id="m_table_QCFORMList_v1OrderListPlainList">
                <thead>
                    <tr>
                        <th>ID#</th>
                        <th>ORDER ID</th>
