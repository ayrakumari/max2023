...
<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                        ...
                        <div class="col-lg-3">
                          ...
                          <select name="" id="txtYearPayRec" class="form-control">
                          <option  value="">-SELECT-</option>
                                <?php 
                        ...
                        <div class="col-lg-3">
                        <button type="button" onclick="getFilterPaymentRecievdReport()" style="margin-top:25px" class="btn btn-primary">Submit</button>
                  ...
                  <br>
									...
									<!--end::Form-->
														...
														<!--begin: Datatable -->
														<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_PaymentRecievdReport">
															<thead>
																<tr>																																	
																	<th>ID</th>
																	<th>Recieved Date </th>																	
                            ...
                            <hr>
                            <div id="filterPaymentRecData"></div>

                            <hr>
                            <div id="perf_div_MonthlyPAY"></div>
                            
                                        <?= Lava::render('ColumnChart', 'FinancesPaymentGF', 'perf_div_MonthlyPAY') ?>
