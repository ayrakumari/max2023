                           ...
                           <div class="m-form__section m-form__section--first">
                              <div class="form-group m-form__group row">
                                 ...
                                 <div class="col-lg-3 m-form__group-sub">
                                    ...
                                    <input type="text"  class="form-control m-input"  name="sample_id" id="sample_id">
                                 </div>
                                 <div class="col-lg-3 m-form__group-sub">
                                    <label class="form-control-label">DUE DATE:</label>
                                    <div class="input-group date">
                                      <input type="text" class="form-control m-input" value="{{ date('j-M-Y')}}" readonly  name="order_due_date" id="m_datepicker_3" />
                                       ...
                                       <div data-repeater-item class="form-group m-form__group row align-items-center">
                                          ...
                                          <div class="col-md-4">
                                            <div class="m-form__group m-form__group--inline">
                                               ...
                                               <div class="m-form__control">
                                                  <input type="text" name="txtSize" class="form-control m-input" placeholder="ml/gm">
                                               </div>
                                            </div>
                                            <div class="d-md-none m--margin-bottom-2"></div>
                                         </div>
