                          ...
                          <div data-repeater-item class="form-group m-form__group row align-items-center">
                            <div class="col-md-4">
                              <div class="m-form__group m-form__group--inline">
                                ...
                                <input type="text" name="txtOrderItem" value="{{$orderitem['item_name'] }}" class="form-control m-input" placeholder="Item Name">
                                </div>
                            ...
                            <div class="col-md-3">
                              <div class="m-form__group m-form__group--inline">
                                ...
                                <div class="m-form__control">
                                  <input type="text" name="txtQTY" value="{{$orderitem['item_qty'] }}" class="form-control m-input" placeholder="qty">
                                </div>
                              </div>
                            ...
                            <div class="col-md-4">
                              <div class="m-form__group m-form__group--inline">
                                ...
                                <div class="m-form__control">
                                  <input type="text" name="txtSize" value="{{$orderitem['item_size'] }}" class="form-control m-input" placeholder="Size">
                                </div>
                              </div>
                              <div class="d-md-none m--margin-bottom-10"></div>
                            </div>
