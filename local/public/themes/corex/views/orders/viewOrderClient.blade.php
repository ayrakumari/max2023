...
<input type="hidden" id="txtClientID_OrderID" value="{{ Request::segment(2) }}">
...
.btn-arrow-left:after {
  ...
  background-color: white;
           ...
           <button type="button" class="btn btn-danger btn-arrow-right">Production</button>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_QCFORMList_VIEWCLIENT">
                    <thead>
                        <tr>
                            <th>ID#</th>
                            <th>ORDER ID</th>                            
