				...
				<div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-2">
							...
							<input type="text" class="form-control" id="m_datepicker_2" readonly placeholder="Select date" />
						</div> 
						<div class="col-lg-2">
						...
						<div class="col-lg-2">
							<label class="">Assined by:</label>
							
							<select class="form-control m-input" id="assinedby">
							<option value="ALL">ALL</option>
							<?php
								$user = auth()->user();
								$userRoles = $user->getRoleNames();
								$user_role = $userRoles[0];
								?>
								@if ($user_role =="Admin" || Auth::user()->id==202 || Auth::user()->id==90 || Auth::user()->id==217)
								@foreach (AyraHelp::getSalesAgentAdmin() as $user)
								@if ($user->id==130 || $user->id==131 
								|| $user->id==78
								|| $user->id==83
						...
						<div class="col-lg-2" style="display: none;">
							...
							<option value="2">Assinged</option>
							<option value="1">Verified</option>
							<option value="55">Hold</option>
						...
						<div class="col-lg-2">
							<button type="button" id="btnShowLeadAssignDateWise" style="margin-top:25px" class="btn btn-primary">Submit</button>
