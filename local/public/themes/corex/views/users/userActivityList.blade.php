                    ...
                    <ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x m-tabs-line--right" role="tablist">
                        <li class="nav-item m-tabs__item">
                            <a class="nav-link m-tabs__link active" data-toggle="tab" href="#m_portlet_base_demo_1_2A_tab_content" role="tab">
                                <i class="fa fa-calendar-check-o" aria-hidden="true"></i>User Activity List
                            </a>
                        </li>
                        <!-- <li class="nav-item m-tabs__item">
                            <a class="nav-link m-tabs__link" data-toggle="tab" href="#m_portlet_base_demo_1_3A_tab_content" role="tab">
                                <i class="fa fa-bar-chart" aria-hidden="true"></i> Add New
                            </a>
                        </li> -->
            ...
            <div class="m-portlet__body">
                <div class="tab-content">
                    <div class="tab-pane active" id="m_portlet_base_demo_1_2A_tab_content" role="tabpanel">
                        ...
                        <!-- ticket list -->
                        <!--begin: Datatable -->
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_ActivityListUser">
                            <thead>
                                <tr>
                                    <th>s#</th>
                                    <th>Name</th>
                                    <th>Acivtity ID</th>
                                    <th>Acivtity Details</th>
                                    <th>Activity By </th>
                                    <th>Activity on</th>                                   
                                    <th>Actions</th>
                                </tr>
                                ...
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group row">
                                        <div class="col-lg-12">
                                            ...
                                            <select name="ticket_user[]" class="form-control m-select2" id="m_select2_9" style="width:100%" name="param" multiple>
