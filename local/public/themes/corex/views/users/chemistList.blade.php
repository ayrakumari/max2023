    ...
    <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Chemist View and EDIT of :{{AyraHelp::getUser( $user_id )->name}}
                    </h3>
                </div>
            </div>
        ...
        <div class="m-portlet__body">
            ...
            <div class="m-portlet">
                ...
                <!--begin::Form-->
                <form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form_updateChemistLayout" method="post" action="{{ route('updateChemistLayout')}}">
                @csrf
                <input type="hidden" name="user_id" id="txtUserID" value="{{$user_id}}">
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group">
                            <label for="example_input_full_name">Limit:</label>
                            <input type="text" name="txtSLimit" class="form-control m-input" value="{{$chemistLimitArr->max_id}}" placeholder="Enter Sample Limit">
                            <span class="m-form__help">Current Assigned Count :<b>{{$chemistLimitArr->pending_count}}</b></span>
                            <span class="m-form__help">Last Formulated on :<b>{{date('j F Y H:iA',strtotime($chemistLimitArr->last_dispatcha_at))}}</b></span>
                        </div>

                        <div class="m-form__group form-group">
                            <label for="">Samples Category:</label>
                            <div class="m-checkbox-list">

                            <?php
                                if ($chemistAssingedArr_1 == null) {
                                ?>
                                    <label class="m-checkbox">
                                        <input value="1" name="sampleCatType[]" type="checkbox"> STANDARD COSMETIC 
                                        <span></span>
                                    </label>
                                <?php
                                ...
                                ?>
                                    <label class="m-checkbox">
                                        <input checked value="1" name="sampleCatType[]" type="checkbox"> STANDARD COSMETIC 
                                        <span></span>
                                    </label>
                                <?php
                                }
                                ...
                                <?php
                                if ($chemistAssingedArr_3 == null) {
                                ?>
                                    <label class="m-checkbox">
                                        <input value="3" name="sampleCatType[]" type="checkbox"> GENERAL CHANGES
                                        <span></span>
                                    </label>
                                <?php
                                ...
                                ?>
                                    <label class="m-checkbox">
                                        <input checked value="3" name="sampleCatType[]" type="checkbox"> GENERAL CHANGES
                                        <span></span>
                                    </label>
                                <?php
                                }
                                ...
                                <?php
                                if ($chemistAssingedArr_4 == null) {
                                ?>
                                    <label class="m-checkbox">
                                        <input value="4" name="sampleCatType[]" type="checkbox"> AS PER BENCHMARK/NPD
                                        <span></span>
                                    </label>
                                <?php
                                ...
                                ?>
                                    <label class="m-checkbox">
                                        <input checked value="4" name="sampleCatType[]" type="checkbox"> AS PER BENCHMARK/NPD
                                        <span></span>
                                    </label>
                                <?php
                                }
                                ...
                                <?php
                                if ($chemistAssingedArr_5 == null) {
                                ?>
                                    <label class="m-checkbox">
                                        <input value="5" name="sampleCatType[]" type="checkbox"> MODIFICATIONS
                                        <span></span>
                                    </label>
                                <?php
                                ...
                                ?>
                                    <label class="m-checkbox">
                                        <input checked value="5" name="sampleCatType[]" type="checkbox"> MODIFICATIONS
                                        <span></span>
                                    </label>
                                <?php
                                }
            ...
            <h1>List of Samples Assigned to : <span style="color:#035496">{{AyraHelp::getUser( $user_id )->name}}</span></h1>

            <!--begin: Datatable -->
            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_SampleChemistAssignedLIST">
                <thead>
                    <tr>
                        <th>ID#</th>
                        <th>Sample ID</th>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btnAssign_ToOther_OWN">Assign NOW</button>
            </div>
        </div>
    </div>
</div>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control m-input" id="assign_user_id">
                            ...
                            $user_role = $userRoles[0];
                            ?>
                            @if ($user_role =="Admin" || Auth::user()->id==77 || Auth::user()->id==90 || Auth::user()->id==171 || Auth::user()->id==130 || Auth::user()->id==131)
                            @foreach (AyraHelp::getSalesAgentAdmin() as $user)
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnLeadNotesSales_OWN" class="btn btn-primary">Save</button>
            </div>
        </div>
    </div>
</div>
