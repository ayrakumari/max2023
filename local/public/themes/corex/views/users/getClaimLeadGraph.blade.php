	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet__body">
		    ...
		    <figure class="highcharts-figure">
				<div id="containerLCSalesTeam"></div>
				<p class="highcharts-description">
					This chart show Lead Claim /Assigned  of last 30 days
				</p>
			</figure>
            <hr>
			<figure class="highcharts-figure">
				<div id="containerLMVC_NVC"></div>
				<p class="highcharts-description">
					This chart show  Lead Verified / Claim
				</p>
			</figure>
			<hr>
			
			<!-- <figure class="highcharts-figure">
				<div id="containerLMVC"></div>
				<p class="highcharts-description">
					This chart show verified Lead Report of LM
				</p>
			</figure>

			<figure class="highcharts-figure">
				<div id="containerLMVCL"></div>
				<p class="highcharts-description">
					This chart show claim Lead Report of LM
				</p>
			</figure> -->

			<figure class="highcharts-figure">
				<div id="containerLverified"></div>
				<p class="highcharts-description">
					This chart show verified Lead Report
				</p>
			</figure>

			<figure class="highcharts-figure">
				<div id="containerLClaim"></div>
				<p class="highcharts-description">
					This chart show claim Lead Report
				</p>
			</figure>
