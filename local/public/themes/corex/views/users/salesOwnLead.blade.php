       ...
       <div class="m-portlet__head">
          ...
          <div class="m-portlet__head-tools">
             <ul class="m-portlet__nav">
				...
				<a href="{{route('AddNewLead')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
													<span>
                   ...
                   <a style="margin:5px" href="/" class="btn btn-secondary m-btn m-btn--custom m-btn--icon">
                   <span>
	   ...
	   <form class="m-form m-form--fit m--margin-bottom-20">
									<div class="row m--margin-bottom-20">
										...
										<div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
											...
											<input type="text" class="form-control m-input" placeholder="" data-col-index="5">
										</div>

										<div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
											<label>My Lead Stage:</label>
          ...
          <!-- form  -->
<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_LEADListSaleOwn">
				<thead>
					<tr>						
						<th>My LID</th>
						<th>Company</th>
