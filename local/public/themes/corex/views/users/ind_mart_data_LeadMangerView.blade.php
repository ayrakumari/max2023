...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					<h3 class="m-portlet__head-text">
						...
						if ($user_role == 'Admin' || $user_role == 'SalesHead' || Auth::user()->id == 134 ||  Auth::user()->id == 141  ||  Auth::user()->id == 144 ||  Auth::user()->id == 145 || Auth::user()->id == 3 || Auth::user()->id == 40 ||  Auth::user()->id == 221  ) {
						?>
			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					<?php
					if ($user_role == 'Admin' || $user_role == 'SalesHead' || Auth::user()->id == 134 || Auth::user()->id == 141 ||   Auth::user()->id == 130 ||  Auth::user()->id == 131 || Auth::user()->id == 221 ) {
					?>
		...
		<div class="m-portlet__body">
			...
			$userRoles = $user->getRoleNames();
			$user_role = $userRoles[0];
			if ($user_role == 'Admin' || $user_role == 'SalesHead' || Auth::user()->id == 1345 || Auth::user()->id == 141 ||   Auth::user()->id == 144 ||   Auth::user()->id == 145 || Auth::user()->id == 3 || Auth::user()->id == 4 || Auth::user()->id == 40 || Auth::user()->id == 221 ) {
			?>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btnAssign_ToOther">Assign</button>
			</div>
		</div>
	</div>
</div>
				...
				<form>
					...
					<div class="form-group">
						...
						<select class="form-control m-input" id="assign_user_id">
							...
							$user_role = $userRoles[0];
							?>
							@if ($user_role =="Admin" || Auth::user()->id==3 || Auth::user()->id==40 || Auth::user()->id==4 || Auth::user()->id==119 || Auth::user()->id==129 || Auth::user()->id==90 || Auth::user()->id==171 || Auth::user()->id==130 || Auth::user()->id==131 || Auth::user()->id==134 || Auth::user()->id==144 || Auth::user()->id==145 || Auth::user()->id==141 || Auth::user()->id == 221 )
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<select class="form-control m-input" id="assign_user_id_calldata">
						...
						$user_role = $userRoles[0];
						?>
						@if ($user_role =="Admin" || Auth::user()->id==3 || Auth::user()->id==77 || Auth::user()->id==90 || Auth::user()->id==171 || Auth::user()->id==130 || Auth::user()->id==131)
						@foreach (AyraHelp::getSalesAgentAdmin() as $user)
