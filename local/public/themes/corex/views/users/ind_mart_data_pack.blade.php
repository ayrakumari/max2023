    ...
    <div class="m-portlet m-portlet--mobile">
       <div class="m-portlet__head">
          <div class="m-portlet__head-caption">
             <div class="m-portlet__head-title" style="display:none">
	   ...
	   <!--begin::Section-->
													...
													<?php
													 ...
													 if($user_role=='Admin' || $user_role=='SalesHead' || Auth::user()->id==77 || Auth::user()->id==3 || Auth::user()->id==4 || Auth::user()->id==40){
														?>
														<div class="m-demo__preview m-demo__preview--btn" style="display:none">
...
<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_LEADList_pack">
				<thead>
					<tr>
										...
										<form>
										   <input type="hidden" id="QUERY_ID" >
											<div class="form-group">
                                                ...
                                                $user_role = $userRoles[0];
                                                ?>
                                                @if ($user_role =="Admin" || Auth::user()->id==3   || Auth::user()->id==4 || Auth::user()->id==40 || Auth::user()->id==119 || Auth::user()->id==129 || Auth::user()->id==90 || Auth::user()->id==171 || Auth::user()->id==130 || Auth::user()->id==131)
                                                @foreach (AyraHelp::getSalesAgentAdmin() as $user)
