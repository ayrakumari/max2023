		...
		<div class="m-portlet__head">
			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					...
					if ($user_role == 'Admin' || $user_role == 'SalesHead' || Auth::user()->id == 134 ||  Auth::user()->id == 130 ||  Auth::user()->id == 131) {
					?>
		...
		<div class="m-portlet__body">
			...
			<div class="m-portlet__body">
				<ul class="nav nav-pills" role="tablist">
					<li class="nav-item ">
						<a class="nav-link active" data-toggle="tab" href="#m_tabs_3_1_Lead"><i class="la la-gear"></i>Lead Panel</a>
					</li>

					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#m_tabs_3_3_assinedLead"><i class="flaticon-users-1"></i>Assinged | Claim Lead</a>
					</li>
                    ...
                    <div class="m-section" style="display:block">
							...
							<div class="m-section__content">
								<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
                                    ...
                                    <a href="javascript::void(0)" onclick="viewClaimAssined_V2()" class="btn btn-success 	btn-sm 	m-btn m-btn--icon">
										<span>
											<i class="fa flaticon-file"></i>
											<span>Claim or Assigned</span>
										</span>
									</a>
