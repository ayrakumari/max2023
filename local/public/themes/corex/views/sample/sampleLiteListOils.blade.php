...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet__body">
			...
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_SampletList_LITE_OILS">
				<thead>
					<tr>
						<th>ID#</th>
						<th>Sample ID</th>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
								...
								<table class="table table-sm m-table m-table--head-bg-metal">
									<thead class="thead-inverse">
										<tr>
											...
											<th style="color:#000">Price/kH</th>
			...
			<div class="modal-footer">
				...
				<!-- <button disabled type="button" id="ajblock_btnSaveSampleSent" class="btn btn-primary ajrow_tr_new">Save changes</button> -->
			</div>
		</div>
	</div>
</div>
