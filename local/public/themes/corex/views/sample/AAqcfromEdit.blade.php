   ...
   <div class="m-portlet m-portlet--mobile">
      ...
      <div class="m-portlet__body">
         <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">          
            <form class="m-form m-form--state m-form--fit m-form--label-align-right"   id="m_form_edit_qcform" method="post" action="{{ route('updateQCdata')}}">
               @csrf
                  ...
                  <div class="m-form__section m-form__section--first">
                     <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-2 m-form__group-sub <?php echo $ajstyle ?>">
                           <label class="form-control-label">Previous Order NO.:</label>
                                             ...
                                             <div class="m-list-search">
                                                <div class="m-list-search__results">
                                                   ...
                                                   <div class="row">
                                                      <div class="col-md-6">
                                                            <a href="javascript::void(0)" class="m-list-search__result-item">
                                                                  <span class="m-list-search__result-item-icon"><i class="flaticon-interface-10 m--font-primary"></i></span>
                                                                  <span class="m-list-search__result-item-text">Design is from Client</span>
                                                               </a>
                                                      </div>
                                                      <div class="col-md-6">
                                                            <div class="m-form__group form-group">                                                     
                                                                  <div class="m-checkbox-inline">
                                                                     ...
                                                                     <div class="col-md-6">
                                                                           <label class="m-checkbox">
                                                                                 <input type="radio" <?php echo $qc_form->design_client=='YES' ? 'checked':'' ?>  name="d_1" value="YES" > YES 
                                                                                 <span></span>
                                                                              </label>
                                                                     </div>
                                                                     <div class="col-md-6">
                                                                           <label class="m-checkbox">
                                                                                 <input type="radio" <?php echo $qc_form->design_client=='NO' ? 'checked':'' ?> name="d_1" value="NO"> NO
                                                                                 <span></span>
                                                                              </label>
                                                                     </div>
                                                                  </div>
                                                   ...
                                                   <div class="row">
                                                         <div class="col-md-6">
                                                               <a href="javascript::void(0)"class="m-list-search__result-item">
                                                                     <span class="m-list-search__result-item-icon"><i class="flaticon-interface-9 m--font-primary"></i></span>
                                                                     <span class="m-list-search__result-item-text">Bottle is from Client</span>
                                                                  </a>
                                                         </div>
                                                         <div class="col-md-6">
                                                               <div class="m-form__group form-group">                                                     
                                                                     <div class="m-checkbox-inline">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                              <label class="m-checkbox">
                                                                                    <input type="radio" <?php echo $qc_form->bottle_jar_client=='YES' ? 'checked':'' ?> name="b_1" value="YES" > YES 
                                                                                    <span></span>
                                                                                 </label>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                              <label class="m-checkbox">
                                                                                    <input type="radio" <?php echo $qc_form->bottle_jar_client=='NO' ? 'checked':'' ?> name="b_1" value="NO"> NO
                                                                                    <span></span>
                                                                                 </label>
                                                                        </div>
                                                                     </div>
                                                   ...
                                                   <div class="row">
                                                         <div class="col-md-6">
                                                               <a href="javascript::void(0)"class="m-list-search__result-item">
                                                                     <span class="m-list-search__result-item-icon"><i class="flaticon-interface-11 m--font-primary"></i></span>
                                                                     <span class="m-list-search__result-item-text"> Label is from Client</span>
                                                                  </a>
                                                         </div>
                                                         <div class="col-md-6">
                                                               <div class="m-form__group form-group">                                                     
                                                                     <div class="m-checkbox-inline">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                              <label class="m-checkbox">
                                                                                    <input type="radio" <?php echo $qc_form->lable_client=='YES' ? 'checked':'' ?> name="l_1" value="YES" > YES 
                                                                                    <span></span>
                                                                                 </label>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                              <label class="m-checkbox">
                                                                                    <input type="radio" <?php echo $qc_form->lable_client=='NO' ? 'checked':'' ?> name="l_1" value="NO"> NO
                                                                                    <span></span>
                                                                                 </label>
                                                                        </div>
                                                                     </div>
