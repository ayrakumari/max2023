      ...
      <div id="div_printme">
        <table class="table table-bordered m-table m-table--border-primary" style="border:1px: solid #000 !important;">
          <thead class="thead-inverse">
            <tr> 
              <th>Pending :<b>Total({{AyraHelp::sampleTotalPendingCosmatic()}})</b> Pending to dispatch since
              </th>
              ...
              <br>
              <b>Printed on :</b><?php echo date('j-M-y H:iA', strtotime(date('Y-m-d H:i:s')))?>
              </td>
            </tr>
          </thead>
              ...
              <table class="table table-sm" style="font-size:14px;border:0px solid #ccc">
                <tbody>
                  <tr>
                    ...
                    <td width="110px">{{$value['sample_code']}} <br></td>
