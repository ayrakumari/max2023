...
<input type="hidden" id="txtMyMark" value="{{ $action_mark}}">
<input type="hidden" id="txtStepCode" value="{{ $step_code}}">
           ...
           <button type="button" class="btn btn-danger btn-arrow-right">Production</button>
            --}}
            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_QCFORMListPendingStage">
                    <thead>
                        <tr>
                            <th>ID#</th>
                            <th>ORDER ID</th>                            
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_5_or6derDispatch" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="orderString"></h5>
            ...
            <div class="modal-body">
                ...
                <!--begin::Form-->
            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('UpdateOrderDispatch')}}" method="post">
                                        @csrf
                                            <input type="hidden" id="txtorderStepID1" name="txtorderStepID1">
                                            <input type="hidden" id="txtOrderID_FORMID1" name="txtOrderID_FORMID1">
                                            <input type="hidden" id="txtProcess_days1" name="txtProcess_days1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="message-text" class="form-control-label">Comment:</label>
                        <textarea class="form-control" id="orderCommentA"></textarea>
                    </div>
                    
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" id="btnProcessComment_Filter" class="btn btn-warning btn-sm m-btn 	m-btn m-btn--icon">
                        <span>                              
                            <span>Process Comment</span>
                        </span>
                </button>
                <button type="button" id="btnProcessComplete_Filter" class="btn btn-primary btn-sm m-btn 	m-btn m-btn--icon">
                        <span>                              
                            <span>Process Complete</span>
                        </span>
                </button>
