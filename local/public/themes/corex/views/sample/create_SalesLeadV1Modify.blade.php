...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            if ($parameters == 'stage_sales-leadv1Modify') {
                $sample_from = 3;
            }
                ...
                <div class="m-portlet__body">
                    <div class="m-form__section m-form__section--first">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4">
                                <label class="">Select Previous Sample ID:</label>
                                <select class="form-control m-select2 orderSampleIDViewSampleModi" id="m_select2_9A" name="previousSample_id">
                                    <?php
                                    $HTML = "";
                                    $usersD = DB::table('samples')->where('is_deleted',0)->where('created_by', Auth::user()->id)->get();
                                            foreach ($usersD as $key => $rowData) {
                                                $HTML .= '<option value='.$rowData->sample_code.'>' . $rowData->sample_code . '</option>';
                                            }
                                            // $usersAj = DB::table('samples_formula')->where('is_deleted',0)->where('user_id', Auth::user()->id)->get();
                    ...
                    <div class="m-form__section m-form__section--first">
                        <!-- repeater -->
                        <div class="form-group m-form__group row">
<input type="hidden" name="txtIsModify" value="1">


                            <div class="col-lg-3 itemNameSample">
