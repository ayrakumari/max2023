  ...
  <div class="m-portlet m-portlet--mobile">
    ...
    <div class="m-portlet__body">
      ...
      <div id="div_printme">
        ...
        $sampleArr = DB::table('samples')->where('status',1)->where('is_deleted',0)->where('sample_type', '=',1)->where('sample_stage_id', '=', 2)->get();
        // print_r($sampleArr);
        // die;

        if (count($sampleArr) > 0) {
        ?>
          <H4><strong>STANDARD COSMETIC : {{count($sampleArr)}} </strong></H4><br>
        <?php
        }
