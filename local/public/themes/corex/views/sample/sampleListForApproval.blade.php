...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet__body">
			...
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_SampletList_PendingApproval">
				<thead>
					<tr>
						<th>ID#</th>
						<th>Sample ID</th>
...
<!--begin::Modal-->
<div class="modal fade" id="m_select2_modal_sampleTechApprovalPrice" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">Final Approval </h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true" class="la la-remove"></span>
				</button>
			</div>
			<form method="post" action="{{route('saveSampleTechDocFeedback_Appproved_price')}}"  class="m-form m-form--fit m-form--label-align-right" id="m_form_3_sampleTechSubmitFeedbackDOC_ApprovalPrice">
				@csrf
				<input type="hidden" name="txtSampleID_DOC" id="txtSampleID_approvalPrice">
				<div class="modal-body">
					<div class="form-group m-form__group row m--margin-top-20">
						<label class="col-form-label col-lg-4 col-sm-12">Size and Price</label>
						<div class="col-lg-4 col-md-6 col-sm-12">
							<input required type="text" name="txtSize_1" class="form-control form-control-sm m-input"  aria-describedby="emailHelp" placeholder="Size 1">
						</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
							<input required type="text" name="txtPrice_1" class="form-control form-control-sm m-input"  aria-describedby="emailHelp" placeholder="Price 1">
						</div>
					</div>
					...
					<div class="form-group m-form__group row m--margin-top-20">
						...
						<select required name="finish_p_catid" id="finish_p_catid" class="form-control m-input select_tags_finish_p_catid">
                           <option value="">--SELECT--</option>
						   <?php
					...
					<div class="form-group m-form__group row m--margin-top-20">
						<label class="col-form-label col-lg-4 col-sm-12">Sub Category</label>
						<div class="col-lg-6 col-md-6 col-sm-12">
						<select required name="finish_p_subcatid" id="finish_p_subcatid" class="form-control m-input">
                           <option value="">--SELECT--</option>
					...
					<div class="form-group m-form__group row m--margin-top-20">
						...
						<div class="col-lg-9 col-md-9 col-sm-12">
							<textarea class="form-control m-input" name="tech_notes_approval" id="exampleTextarea" rows="2"></textarea>
						</div>
				...
				<div class="modal-footer">
					...
					<button type="submit" data-wizard-action="submitSaveSampleTechApproval" class="btn btn-primary submitSaveSampleTech">Submit</button>
...
<!--begin::Modal-->
<div class="modal fade" id="m_select2_modal_sampleTechFeedbackDoc" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">Sample Feedback </h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true" class="la la-remove"></span>
				</button>
			</div>
			
				<div class="modal-body showfeedbackSample">
