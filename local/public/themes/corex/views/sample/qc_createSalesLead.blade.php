   ...
   <div class="m-portlet m-portlet--mobile">
      ...
      <div class="m-portlet__body">
         <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">
            <form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form_add_qcform" method="post" action="{{ route('saveLeadQCdata')}}">
               @csrf
                                 ...
                                 <div class="m-list-search__results">
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <a href="javascript::void(0)" class="m-list-search__result-item">
                                             <span class="m-list-search__result-item-icon"><i class="flaticon-interface-3 m--font-primary"></i></span>
                                             <span class="m-list-search__result-item-text">TAMPER PROOFING</span>
                                          </a>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="m-form__group form-group">
                                             <div class="m-checkbox-inline">
                                                <div class="row">
                                                   <div class="col-md-6">
                                                      <label class="m-checkbox">
                                                         <input type="radio" name="f_10" value="YES"> YES
                                                         <span></span>
                                                      </label>
                                                   </div>
                                                   <div class="col-md-6">
                                                      <label class="m-checkbox">
                                                         <input type="radio" name="f_10" value="NO"> NO
                                                         <span></span>
                                                      </label>
                                                   </div>
                                                </div>
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Packaging Catalog</h5>
