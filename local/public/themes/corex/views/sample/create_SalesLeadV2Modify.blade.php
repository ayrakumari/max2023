...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Add Modify Samples for Lead:<b style="color:#035496">{{@$users->brand}}({{@$users->company}})</b>
                    </h3>
                </div>
            </div>
        ...
        <div class="m-portlet__body">
            ...
            if ($parameters == 'stage_sales-leadv2Modify') {
                $sample_from = 3;
            }
            //die;
            ?>
            ...
            // die;
            ?>
            <form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form_add_sample" method="post" action="{{ route('saveSalesLeadSampleV2')}}">
                @csrf
                ...
                <div class="m-portlet__body">
                    ...
                    <!-- sample detaila -->
                    <input type="hidden" name="sample_type" value="{{$samples_data->sample_type}}">
                    <div class="m-form__section m-form__section--first">
                        <!-- repeater -->
                        <div class="form-group m-form__group row" style="background-color: #FFF;">
                            <div class="col-lg-3">
                                ...
                                $sample_typeModi=$samples_data_items->sid_partby_code.'| '.$samples_data_items->item_name;

                                ?>
                                <label style="color:#035496">Item Name:</label>
                                <input type="hidden" value="1" id="txtIsModify" name="txtIsModify">
                                <input type="hidden"  value="{{$sample_typeModi}}" id="txtIsModifyItem" name="txtIsModifyItem">

                                <div class="input-group m-input-group m-input-group--square">
                               
                                <?php 
                                  $sampleDetailArr = DB::table('samples')->where('id',$samples_data->id)->where('is_deleted',0)                                        
                                  ->first();
                                  if($sampleDetailArr->sample_type==5){
                                      ?>
                                       <input type="text"  placeholder="{{$samples_data_items->item_name}}" id="txtSample_Name" name="txtSample_Name" class="form-control m-input" placeholder="">


                                      <?php
                                  }else{
                                    ?>
                                    <select id="txtSample_Name" name="txtSample_Name" class="form-control">
                                        <?php 
                                        $sItemArr=json_decode($sampleDetailArr->sample_details);
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="input-group m-input-group m-input-group--square">
                                <select id="txtSample_Fragrance" name="txtSample_Fragrance" class="form-control">
                                    <option title="Zesty or tangy notes like mandarins or bergamot." value="Citrus">Citrus</option>
                                    <option title="Sweet, edible and tropical like peach, pear and apple." value="Fruity">Fruity</option>
                                    <option title="Smells like fresh-cut flowers — imagine rose and lily" value="Floral">Floral</option>
                                    <option title="Aromatic scents like cedarwood, sandalwood and vetiver" value="Woody">Woody</option>
                                    <option title="Clean and fresh herbs mixed with lavender or woody scents." value="Aromatic">Aromatic</option>
                                    <option title="Soft, powdery and sweet with a hint of creamy." value="Soft Floral">Soft Floral</option>
                                    <option title= "Sweet like Candy, having a pleasant smell" value="Sweet">Sweet</option>
                                    <option title= "Aquatic scents that smell of sea spray or rain mixed with or oceanic notes." value="Sweet">Aqua-Water</option>
                                    <option title= "Select Others" value="Other">Other</option>                                 
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="input-group m-input-group m-input-group--square">
                                    ...
                                    <input style="text-align: right;"value="{{$samples_data_items->price_per_kg}}"  type="text" id="m_inputmask_67" class="form-control m-input" placeholder="">
                                </div>
                                <span class="m-form__help"></span>
                            </div>
