...
@endif
			...
			<!--begin: Search Form -->
			<form class="m-form m-form--fit m--margin-bottom-5">
				<div class="row m--margin-bottom-5">
					...
					<div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
					 <button style="margin-top:30px" class="btn btn-brand m-btn m-btn--icon" id="m_search">
							<span>
								<i class="la la-search"></i>								
							</span>
						</button>
						<button style="margin-top:30px" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
							<span>
			...
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable ajayra" id="m_table_SampletList_SALESDASH">
				<thead>
					<tr>
						<th>ID#</th>
						<th>Sample ID</th>
...
<!-- m_modal_6_payment_add_sample -->
<div class="modal fade" id="m_modal_6_payment_add_sample" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content  modal-lg">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle">Sample Payment Upload</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			...
			<div class="modal-body">
				<form id="frmbtnsavePaymentSample" action="{{route('savePaymentAmountSample')}}" method="post" enctype="multipart/form-data">
				@csrf
				<div id="payItemSampleDiv">
				</div>
				<input type="hidden" name="sample_id_pay" id="sample_id_pay">
				...
				<div class="form-group m-form__group" style="display: none;">
								...
								<div class="form-group m-form__group">
									...
									<input type="text" readonly name="payAmt" id="payAmt"  class="form-control">
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="txtPayRemak" name="txtPayRemak"></textarea>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				<button type="submit" id="btnsavePaymentSample" class="btn btn-primary">Submit Payment</button>
			</div>
			</form>
		</div>
	</div>
