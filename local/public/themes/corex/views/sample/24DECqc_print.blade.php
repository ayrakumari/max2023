...
<div class="m-content">
						...
						<div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                ...
                                <?php 
                                  ...
                                  if($user_role=='Admin' || Auth::user()->id==90  || Auth::user()->id==171|| $user_role=='SalesUser'){
                                    ?>
						...
						<div class="m-portlet__body">
                          ...
                          <div id="div_printme"> 
                                ...
                                <table cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            <td colspan=6 height="23" align="center"><b><font face="Liberation Serif" size=4>MAX -ORDER QC FORM</font></b></td>
                                            </tr>
                                        <tr>
                                            <td height="30" align="left"><b>ORDER NO:</b></td>
                                            <td align="center"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{$qc_data->order_id}}/{{$qc_data->subOrder}}</strong></font></td>
                                            <td colspan=2 align="left"><b>BRAND /REF NAME: </b></td>
                                            <td colspan=2 align="center"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{ $qc_data->brand_name }}</strong></font></td>
                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" sdval="525252" sdnum="16393;"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{  $qc_data->order_repeat ==2 ? $qc_data->pre_order_id :''}}</strong></font></td>
                                        </tr>
                                        
                                        <tr>
                                            <td colspan=2 height="24" align="left"><b>ITEM NAME/DESCRIPTION</b></td>
                                            <td colspan=4 align="center"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{ $qc_data->item_name }}</strong></font></td>
                                          
                                        </tr>
                                        <tr>
                                            <td colspan=2 height="18" align="left"><b>SALES PERSON</b></td>
                                            <td colspan=4 align="left"><font face="Liberation Serif" size=2 font-weight: 700><strong> {{ strtoupper(AyraHelp::getUser($qc_data->created_by)->name) }}</strong></font></td>
                            ...
                            <table cellspacing="0" border="1">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{ date("d-F-Y", strtotime($qc_data->created_at))  }}</strong></font></td>
                                    <td align="center"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{ date("d-F-Y", strtotime($qc_data->due_date))  }}</strong></font></td>
                                    <td align="left"><br></td>
                                    <td align="left"><br></td>
                                    <td align="left"><br></td>
                                </tr>
                                ...
                                foreach ($qc_bom as $key => $value) {
                                    ...
                                    if($value->bom_from=='N/A'){
                                        ...
                                        if(isset($value->m_name)){
                                            ?>
                                          <td  height="20" align="left" bgcolor="#CCCCCC"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{$value->m_name}} {{$value->bom_from}}</strong></font></td>
                                        <?php
                                        }else{
                                            ?>
                    ...
                    <td colspan=6 height="30"  align="left" valign=middle><b>2.PRODUCTION PROCESS</b></td>
                        ...
                        <tr>
                            ...
                            <td colspan=2 align="center" valign=middle bgcolor="#999999"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{ $qc_data->item_fm_sample_no }}</td>
                        ...
                        ?>
                        <tr>
                            <td height="33" align="center" bgcolor="#999999"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{ $sizeUnit }} </strong></font></td>
                            <td colspan=2 align="center" valign=middle bgcolor="#999999"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{ $nounit }}</strong></font></td>
                            <td align="center" bgcolor="#999999"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{ $batchSize}}</strong></font></td>
                            <td colspan=2 align="center" valign=middle bgcolor="#999999"><br></td>
                        </tr>
                        <tr>
                ...
                <br>
                    ...
                    <style type="text/css">
                      ...
                      <table cellspacing="0" border="1">
                        ...
                        <tr>
                            <td height="32" align="left"><b>PACKAGING REMARKS</b></td>
                            <td  colspan=6  align="center">
                            ...
                            foreach ($qc_pp as $key => $valueqc) {                                 
                               ...
                               if($qc_data->order_type=='Bulk'){
                                ...
                                ?>
                                 ...
                                 <td align="center"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{$qy}}</strong></font></td>
                                 <td align="center"><font face="Liberation Serif" size=2 font-weight: 700><strong>{{$qn}}</strong></font></td>
