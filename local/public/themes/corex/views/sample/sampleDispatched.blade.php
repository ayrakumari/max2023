...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
				...
				<div class="m-portlet__head-title">
					...
					<table style="margin-left:30px;">
						<tr>
							...
							<td>
								<button onclick="unAssinedSampleList()" type="button" class="btn btn-outline-default btn-sm"> Pending Sample <span class="m-badge m-badge--warning">{{ $spcount=AyraHelp::sampleUnassigned()}}</span></button>
							</td>
							<td>
								<button onclick="unAssinedSampleList_OIL_ONLY()" type="button" class="btn btn-outline-default btn-sm"> Oils Only <span class="m-badge m-badge--warning">{{ $spcount=AyraHelp::sampleUnassigned_OILONLY()}}</span></button>
							</td>
							<td>
								<button onclick="AssinedSampleList()" type="button" class="btn btn-outline-default btn-sm"> Assigned Count <span class="m-badge m-badge--primary">{{ $spcount=AyraHelp::sampleAssignedAdmin()}}</span></button>
							</td>
		...
		<div class="m-portlet__body">
				...
				<div class="row m--margin-bottom-20">
					...
					<div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
						...
						<select class="form-control m-input" data-col-index="6">
							...
							?>
							@if ($user_role =="Admin" || $user_role =="SalesHead" || Auth::user()->id==89)
					...
					<div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
						...
						<select class="form-control m-input" data-col-index="9">
							...
							<option value="4">AS PER BENCHMARK </option>
			...
			<input type="hidden" id="sidStatus" value="2">
