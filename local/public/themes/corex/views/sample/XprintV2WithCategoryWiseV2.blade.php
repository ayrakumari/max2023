                ...
                <table cellspacing="0" border="0">
                    ...
                    <?php foreach ($sample_arr_Admin as $key => $value) : ?>
                        ...
                        <?php
                            ...
                            foreach ($samplesDataItemArr as $key => $rowData) {
                                    ...
                                    if($samplesDataArr->is_modify_sample==1){
                                        $strModifyLink=$samplesDataArr->modify_sample_pre_code;
                                    }else{
                                        $strModifyLink="";
                                    }
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=7 align="left">
                                <span style="font-size: 12px;">{{ucwords(strtolower(@$rowData->item_info))}} </span>
                            </td>
                        </tr>
                        <tr>
                                  <td style="border-top: 1px solid #333333; border-bottom: 1px solid #333333; border-left: 1px solid #333333; border-right: 1px solid #333333" height="5" align="left"> <span style="font-size: 11px;font-weight:400">Notes</span></td>
                                  <td style="border-top: 1px solid #333333; border-bottom: 1px solid #333333; border-left: 1px solid #333333; border-right: 1px solid #333333" colspan=7 align="center" valign=middle><span style="font-size: 11px;font-weight:400">{{@$samplesDataArr->remarks}}</span></td>
                              </tr>
