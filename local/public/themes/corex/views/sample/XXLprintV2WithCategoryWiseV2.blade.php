                    ...
                    <?php foreach ($sample_arr_Admin as $key => $value) : ?>
                        ...
                        <?php
                            ...
                            foreach ($samplesDataItemArr as $key => $rowData) {
                                ...
                                ?>
                                 <tr>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" height="26" align="center" valign=middle><b>
