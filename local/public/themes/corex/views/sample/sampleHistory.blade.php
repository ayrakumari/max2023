...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<table style="margin-left:30px; display:block">
						<tr>
							<td>
							...
							<!-- <td>
								<button onclick="unAssinedSampleList_Cosmatic()" type="button" class="btn btn-outline-default btn-sm"> Unassigned Count <span class="m-badge m-badge--warning">{{ $spcount=AyraHelp::sampleUnassigned()}}</span></button>
							</td> -->
							<td>
								<button onclick="AssinedSampleList__Cosmatic()" type="button" class="btn btn-outline-default btn-sm"> assigned Count <span class="m-badge m-badge--primary">{{ $spcount=AyraHelp::sampleAssigned()}}</span></button>
							</td>
			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					...
					<li class="m-portlet__nav-item">
						<a  style="display:none" href="{{route('sample.print.all')}}" class="btn btn-accent m-btn m-btn--custom m-btn--icon">
							<span>
		...
		<div class="m-portlet__body">
			...
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_SampletList_LITE_HISTORY">
				<thead>
					<tr>
						<th>ID#</th>
						<th>Sample ID</th>
...
<div class="modal fade" id="m_modal_6_assinedSampleToTID" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle">Sample Tracking ID</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<input type="hidden" name="sampleIDATrackID" id="sampleIDATrackID">


				<div class="form-group m-form__group">
					<label>Tracking ID</label>
					<div class="input-group">
						<input type="text" class="form-control" id="txtTrackIDV" name="txtTrackIDV">
					</div>
				</div>
				<div class="form-group">
					<label for="message-text" class="form-control-label">*Remarks:</label>
					<textarea class="form-control" id="txtSampleAssinedRemarkTID" name="txtSampleAssinedRemarkTID"></textarea>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				<button type="button" id="btnSaveSampleAssingnTrackID" class="btn btn-primary">Submit</button>
			</div>
		</div>
	</div>
</div>