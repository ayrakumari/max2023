...
.btn-arrow-left:after {
  ...
  background-color: white;
           ...
           <button type="button" class="btn btn-danger btn-arrow-right">Production</button>
            --}}
            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_QCFORMList_dispatched">
                    <thead>
                        <tr>
                            <th>ID#</th>
                            <th>ORDER ID</th>                            
        ...
        <div class="m-section">           
              ...
              <!--end::Section-->
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#" data-target="#m_tabs_1_1">Dispatched Details</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">Stages Details</a>
                        </li>
           ...
           display: block;
                  ...
                  <div class="row">
                      <div class="col-lg-12 ">
                        ...
                        <h3>Stages</h3>
                        <ul class="progress-indicator aj_statges_individual5">
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_5_orderComment_OrderPartial" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_5_orderComment_OrderPartialAA" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
