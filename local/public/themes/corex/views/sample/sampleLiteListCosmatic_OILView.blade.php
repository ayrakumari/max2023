...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet__body">
				...
				<div class="row m--margin-bottom-20">
					...
					<div class="col-lg-2 m--margin-bottom-10-tablet-and-mobile">
						...
						<select class="form-control m-input" data-col-index="7">
							...
							<option value="2">FORMULATION</option>
			...
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_SampletList_LITE_COSMATIC_oilView">
				<thead>
					<tr>
						<th>ID#</th>
						<th>Sample ID</th>
