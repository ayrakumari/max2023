						...
						<div class="m-portlet m-portlet--mobile">
                          ...
                          <div id="div_printme" >
                                ...
                                <table cellspacing="0" border="1">
                                    ...
                                    <?php 
                                    $i=0;
                                foreach (AyraHelp::samplePendingDispatchData(3) as $key => $value) {
                                    $i++;
                                    $sType = "";
                                ...
                                <table cellspacing="0" border="1">
                                    ...
                                    <?php 
                                      $i=0;
                                foreach (AyraHelp::samplePendingDispatchData(7) as $key => $value) {
                                    $i++;
                                    $sType = "";
                                    switch ($value->sample_type) {
                                        case 1:
                                ...
                                <table cellspacing="0" border="1">
                                    ...
                                    <?php 
                                    $i=0;
                                foreach (AyraHelp::samplePendingDispatchData(15) as $key => $value) {
                                   $i++;
                                   $sType = "";
                                   switch ($value->sample_type) {
                                       case 1:
