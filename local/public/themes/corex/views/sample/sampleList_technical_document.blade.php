...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
			...
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					<h3 class="m-portlet__head-text">
						Sample :Technical Document View
					</h3>
				</div>
			</div>
		...
		<div class="m-portlet__body">
			...
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_SampletList_technicaldoc">
				<thead>
					<tr>
						<th>ID#</th>
						<th>Sample Date </th>
...
<div class="modal fade" id="m_select2_modal_sampleTechDOC" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form method="post" action="{{route('saveSampleTechDocFeedback_DOC')}}" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right" id="m_form_3_sampleTechSubmitFeedbackDOC">
				@csrf
