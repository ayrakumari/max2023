...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="display:block">
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">

                        <div class="col-lg-2">
                            <label class="">Month From:</label>
                            <input type="text" class="form-control" id="m_datepicker_3" readonly placeholder="Select date" />
                        </div>
                        <div class="col-lg-2">
                            <label class="">Month To:</label>
                            <input type="text" class="form-control" id="m_datepicker_3A" readonly placeholder="Select date" />
                        </div>
                        <div class="col-lg-3">
                            <label class="">Sales Person:</label>

                            <select class="form-control m-input" id="user_id">
                                <?php
                                $user = auth()->user();
                                $userRoles = $user->getRoleNames();
                                $user_role = $userRoles[0];
                        ...
                        <div class="col-lg-2">
                            <label class="">Filter For</label>

                            <select class="form-control m-input" id="order_for">
                                <option selected value="1">Payment</option>
                                <option selected value="2">Order</option>
                                <option selected value="3">Sample</option>
                                <option selected value="4">Lead</option>
                            </select>
                        </div>
                        <style>
    ...
    margin-top: 35px;
                            ...
                            <div class="m-form__group form-group">
                                ...
                                <div class="m-checkbox-inline">
                                    <label class="m-checkbox">
                                        <input value="1" id="chkEmail"  name="chkEmail" type="checkbox">Email?
                                        <span></span>
                                    </label>
                        ...
                        <div class="col-lg-1">
                            <button type="button" id="btnShowPaymentOrdersListWithFilter" style="margin-top:25px" class="btn btn-success">GET</button>
