        ...
        <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">
          ...
          <div class="m-portlet">
            ...
            <div class="m-portlet__body">
              <!-- form  -->
              <!--begin::Form-->
              <form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form_add_clientLead" data-redirect="{{route('getINDMartDataLeadManagerView')}}" method="post" action="{{route('saveLeadData')}}">
                @csrf
                <div class="m-portlet__body">
