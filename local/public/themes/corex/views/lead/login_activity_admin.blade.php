    ...
    <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                  <li class="m-portlet__nav-item">
                      <a href="javascript::void(0)" id="btnRefesh" class="btn btn-secondary m-btn m-btn--custom m-btn--icon">
                          <span>
        ...
        <div class="m-portlet__body">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" >
              ...
              <tbody>
              <?php
                 $lead_data=AyraHelp::getAllWorkingUser();
                 $i=0;
                 foreach ($lead_data as $key => $row) {
                   // print_r($row);
                   $str=AyraHelp::getUserActiveStatus($row['uid']);
                   $sty="m-badge m-badge--".$str;
                   // die;
                   $i++;
                   ?>
                   <tr>
            ...
            <h2>Call Activity</h3>
            <!--begin: Datatable -->
            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_click2CallActivity">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Customer No.</th>
