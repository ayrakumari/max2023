...
<div class="m-content" style="display:block">
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            <!--begin: Datatable -->
            <table class="table table-striped- table-bordered table-hover table-checkable ajayra" id="m_table_ticketv2_AllView">
                <thead>
                    <tr>
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_ViewTicketHis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__body">
                        <ul class="nav nav-pills nav-fill" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#m_tabs_5_1">TICKET INFO</a>
                            </li>
                            <li class="nav-item">
...
<!--begin::Modal-->
<div class="modal fade" id="m_modal_ticketUpdateModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control m-input" id="assign_user_idTicket">
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control m-input" id="ticket_id_status">
                    ...
                    <div class="form-group">
                        <label for="message-text" class="form-control-label">Message:</label>
                        <textarea class="form-control" id="assign_msgTicket"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-warning" id="btnTicketUpdate">Submit</button>
            </div>
        </div>
    </div>
</div>
