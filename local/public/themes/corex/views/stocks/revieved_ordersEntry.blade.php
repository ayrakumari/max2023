                       ...
                       <div class="m-portlet__body">
                          <div class="m-form__section m-form__section--first">
                             <div class="form-group m-form__group row">
                                <div class="col-lg-4 m-form__group-sub">
                                   ...
                                   <input type="text" class="form-control m-input"  name="pid" id="pid_event" placeholder="Enter Purchase Order ID">
                                </div>
                          ...
                          <div class="m-form__section m-form__section--first">
                             <div class="form-group m-form__group row">
                                ...
                                <input type="text"  class="form-control m-input" id="item_code" name="item_code" placeholder="Enter Item Code" >
                                </div>
                                <div class="col-lg-4 m-form__group-sub">
                                   <label class="form-control-label">Item Name:</label>
                                   <input type="text"  class="form-control m-input" name="item_name" id="item_name" placeholder="Enter Item Name" >
                                </div>
                                <div class="col-lg-2 m-form__group-sub">
                                   <label class="form-control-label">QTY:</label>
                                   <input type="text"  class="form-control m-input" name="qty" id="qty" placeholder="Enter QTY" >
                                </div>
                                <div class="col-lg-2 m-form__group-sub">
