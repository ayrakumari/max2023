...
<div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
              ...
              <div class="m-portlet__head-tools">
                 <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                       <a href="{{route('stocks.create')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon">
                       <span>
           ...
           <div class="m-portlet__body">
              ...
              <!--begin: Datatable -->
             <!--begin: Datatable -->
		<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_stockList">
                <thead>
                      <tr>
                                      <th>S#</th>
                                      <th>ItemCode</th>
                ...
                <tbody>
                          ...
                          foreach ($data as $key => $value) {
                             ...
                             <tr>
                                 ...
                                 <td>{{$value['item_discrption']}}</td>
                                 <td>{{$value['stock_in']}}</td>
                                 <td>{{$value['reserved_in']}}</td>
                                 <td>{{$value['stock_minLevel']}}</td>                                 
                                 <td>2</td>
