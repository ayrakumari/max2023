   ...
   <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
      ...
      <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
         ...
         <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
            ...
            <div class="m-menu__submenu ">
               ...
               <ul class="m-menu__subnav">
                  ...
                  <li class="m-menu__item " aria-haspopup="true"><a href="{{ route('client.notes')}}" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Call Details</span></a>
                  </li>
         ...
         ?>
               <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                  <a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-interface-7"></i><span class="m-menu__link-text">
                        Leads A <span class="m-badge m-badge--warning" title="Assign Lead Count Today">{{count($data_arr_data_data)}}</span> </span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                  <div class="m-menu__submenu ">
                     <span class="m-menu__arrow"></span>
                     <ul class="m-menu__subnav">
                        <?php
         ...
         <?php
         if (Auth::user()->id == 90 || Auth::user()->id == 1) {
         ?>

            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
               <a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-interface-7"></i><span class="m-menu__link-text">
                     Fresh Lead</span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
               <div class="m-menu__submenu ">
                  <span class="m-menu__arrow"></span>
                  <ul class="m-menu__subnav">
                     ...
                     <li class="m-menu__item " aria-haspopup="true">
                        <a href="{{ route('getAllLeadUntouch')}}" class="m-menu__link ">
                           <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                           <span class="m-menu__link-text">Fresh Lead List</span>
                        </a>
                     </li>
         ...
         if (Auth::user()->hasPermissionTo('LeadManagement')) {
            if (Auth::user()->id == 1 || Auth::user()->id == 119  | Auth::user()->id == 129 || Auth::user()->id == 3 || Auth::user()->id == 90 || Auth::user()->id == 129 || Auth::user()->id == 134 || Auth::user()->id == 141 || Auth::user()->id == 142 || Auth::user()->id == 139 || Auth::user()->id == 140 || Auth::user()->id == 40  || Auth::user()->id == 4 || Auth::user()->id == 135 || Auth::user()->id == 136) {
         ?>
               <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                  <a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-interface-7"></i><span class="m-menu__link-text">
         ...
         <li class="m-menu__item  m-menu__item" aria-haspopup="true"><a href="{{route('loginActivity')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-plus"></i><span class="m-menu__link-title"> <span class="m-menu__link-wrap"> User Activity
                     <span class="m-menu__link-badge"></span> </span></span></a>
         </li>
         <!-- ajcode for new menu -->
         <?php
         ...
         ?>
            ...
            <li class="m-menu__item  m-menu__item" aria-haspopup="true"><a href="{{route('LeadManagementView')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-plus"></i><span class="m-menu__link-title"> <span class="m-menu__link-wrap"> Lead Manage
                        <span class="m-menu__link-badge"></span> </span></span></a>
            </li>
