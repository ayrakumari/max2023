    ...
    return {
        init: function() {
            ...
            ! function() {
                ...
                if (0 != e.length) {
                    //data
                    $.getJSON(BASE_URL+'/api/getSampleGraphList',{ userid : $('meta[name="UUID"]').attr('content')}, function(datar) {
                     //ole.log(datar.lable);
                     //console.log(datar.DataVal);
                     var t = {
                        labels:datar.lable,
                        datasets: [{
                    ...
                    if (0 != $("#m_dashboard_daterangepicker").length) {
                        ...
                        e.daterangepicker({
                            ...
                            ranges: {
                                ...
                                "For 7 Days": [moment().add(7, "days"), moment()],
                                "For 10 Days": [moment().add(10, "days"), moment()],
