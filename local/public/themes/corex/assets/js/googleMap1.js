...
drawChart_chart_div_knowRecv3();
drawChart_chart_div_knowOut3();
drawChart_chart_div_knowRecvSalewise();
//chart_div_knowRecv_saleswise
drawChart_chart_div_BUYLEAD_ALLAPI();
drawChart_chart_div_KnowMissedCall();
...
// drawChart_chart_div_knowRecvSalewise
function drawChart_chart_div_knowRecvSalewise(){
  google.charts.setOnLoadCallback(drawVisualization_13);

  function drawVisualization_13() {
      // Some raw data (not necessarily accurate)
      ...
      var jsonData = $.ajax({
      url: BASE_URL+'/getLast30DaysINOUT_knowlarity',
      dataType: "json",
      type: "POST",
      data: formData,
      async: false
      ...
      var options = {
          title: 'Outgoing  Salesman last 30 Days of Knowlarity',
          vAxis: {
              title: 'NO of Calls'
          },
          hAxis: {
      ...
      var chart = new google.visualization.ComboChart(document.getElementById('chart_div_knowRecv_saleswise'));
      chart.draw(data, options);
  }

}
//drawChart_chart_div_KnowMissedCall
function drawChart_chart_div_KnowMissedCall(){
  google.charts.setOnLoadCallback(drawVisualization_1);
  ...
  function drawVisualization_1() {
      ...
      var jsonData = $.ajax({
      url: BASE_URL+'/getThisMonthKNOW_MissedRec_API_DATA',
      dataType: "json",
      type: "POST",
      data: formData,
      async: false
      ...
      var options = {
          title: 'Knowlarity Missed/Received Calls of   '+now,
          vAxis: {
              title: 'No of Lead'
          },
          hAxis: {
      ...
      var chart = new google.visualization.ComboChart(document.getElementById('chart_div_KnowMissedCall'));
      chart.draw(data, options);
  }
...
//drawChart_chart_div_BUYLEAD_ALLAPI
function drawChart_chart_div_BUYLEAD_ALLAPI(){
  google.charts.setOnLoadCallback(drawVisualization_1);
  ...
  function drawVisualization_1() {
      ...
      var jsonData = $.ajax({
      url: BASE_URL+'/getThisMonthBUYLEAD_API_DATA',
      dataType: "json",
      type: "POST",
      data: formData,
      async: false
      ...
      var chart = new google.visualization.ComboChart(document.getElementById('chart_div_BUYLEAD_ALL_API'));
      chart.draw(data, options);
  }
...
//drawChart_chart_div_BUYLEAD_ALLAPI
//chart_div_knowRecv
function drawChart_chart_div_knowOut3(){
  google.charts.setOnLoadCallback(drawVisualization_1);
  ...
  function drawVisualization_1() {
      ...
      var jsonData = $.ajax({
      url: BASE_URL+'/getThisMonthKnowlarityOUT',
      dataType: "json",
      type: "POST",
      data: formData,
      async: false
      ...
      var options = {
          title: 'Knowlarity Outgoing Call '+now,
          vAxis: {
              title: 'NO of Calls'
          },
          hAxis: {
      ...
      var chart = new google.visualization.ComboChart(document.getElementById('chart_div_knowOutv'));
      chart.draw(data, options);
  }
...
//chartdiv_outknow
//chart_div_knowRecv
function drawChart_chart_div_knowRecv3(){
  google.charts.setOnLoadCallback(drawVisualization_1);
  ...
  function drawVisualization_1() {
      ...
      var jsonData = $.ajax({
      url: BASE_URL+'/getThisMonthKnowlarityIN',
      dataType: "json",
      type: "POST",
      data: formData,
      async: false
      ...
      var chart = new google.visualization.ComboChart(document.getElementById('chart_div_knowRecv'));
      chart.draw(data, options);
  }
...
function drawChart_2(){
  ...
  function drawVisualization_1() {
      ...
      var options = {
          title: 'Call Received / Missed Call  of last 30 days',
          vAxis: {
              title: 'No of Calls'
          },
          hAxis: {
